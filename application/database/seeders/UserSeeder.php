...
class UserSeeder extends Seeder
{
    ...
    public function run()
    {
        $users = [
           ...
           ['name' => 'COD 2', 'username' => 'coddbs', 'password' => Hash::make('1234'), 'role_id' => 2, 'department_id' => 2,],
           ['name' => 'COD 3', 'username' => 'coddms', 'password' => Hash::make('1234'), 'role_id' => 2, 'department_id' => 3,],
           ['name' => 'COD 4', 'username' => 'coddabe', 'password' => Hash::make('1234'), 'role_id' => 2, 'department_id' => 4,],
           ['name' => 'COD 5', 'username' => 'coddbc', 'password' => Hash::make('1234'), 'role_id' => 2, 'department_id' => 5,],
           ...
           ['name' => 'COD 8', 'username' => 'coddma', 'password' => Hash::make('1234'), 'role_id' => 2, 'department_id' => 8,],
           ...
           ['name' => 'COD 11', 'username' => 'coddas', 'password' => Hash::make('1234'), 'role_id' => 2, 'department_id' => 11,],
           ['name' => 'COD 12', 'username' => 'codmds', 'password' => Hash::make('1234'), 'role_id' => 2, 'department_id' => 12,],
           ['name' => 'COD 13', 'username' => 'coddls', 'password' => Hash::make('1234'), 'role_id' => 2, 'department_id' => 13,],
           ['name' => 'COD 14', 'username' => 'codhtm', 'password' => Hash::make('1234'), 'role_id' => 2, 'department_id' => 14,],
           ['name' => 'COD 15', 'username' => 'coddmg', 'password' => Hash::make('1234'), 'role_id' => 2, 'department_id' => 15,],
...
////            ['name' => 'Admin', 'username' => 'admin'.'@gmail.com', 'password' => Hash::make('1234'), 'role_id' => 0,],
        ...
        DB::table('schools')->insert([
            ...
            ['initials'=>'ICI', 'name'=>'SCHOOL OF COMPUTING AND INFORMATICS'],
        ]); 

        DB::table('departments')->insert([
            ['school_id'=>'1', 'dept_code'=>'DAF', 'name'=>'DEPARTMENT OF ACCOUNTING AND FINANCE'],
            ['school_id'=>'1', 'dept_code'=>'DBS', 'name'=>'DEPARTMENT OF BUSINESS ADMINISTRATION'],
            ['school_id'=>'1', 'dept_code'=>'DMS', 'name'=>'DEPARTMENT OF MANAGEMENT SCIENCE'],
            ['school_id'=>'2', 'dept_code'=>'DABE', 'name'=>'DEPARTMENT OF ARCHITECTURE AND BUILT ENVIRONMENT'],
            ['school_id'=>'2', 'dept_code'=>'DBC', 'name'=>'DEPARTMENT OF BUILDING AND CIVIL ENGINEERING'],
            ...
            ['school_id'=>'2', 'dept_code'=>'DMA', 'name'=>'DEPARTMENT OF MECHANICAL AND AUTOMOTIVE ENGINEERING'],
            ...
            ['school_id'=>'3', 'dept_code'=>'DAS', 'name'=>'DEPARTMENT OF PURE AND APPLIED SCIENCES'],
            ['school_id'=>'3', 'dept_code'=>'MDS', 'name'=>'DEPARTMENT OF MEDICAL SCIENCES'],
            ['school_id'=>'4', 'dept_code'=>'DLS', 'name'=>'DEPARTMENT OF SOCIAL SCIENCES'],
            ['school_id'=>'4', 'dept_code'=>'HTM', 'name'=>'DEPARTMENT OF HOSPITALITY AND TOURISM MANAGEMENT'],
            ['school_id'=>'4', 'dept_code'=>'DMG', 'name'=>'DEPARTMENT OF COMMUNICATION STUDIES'],
