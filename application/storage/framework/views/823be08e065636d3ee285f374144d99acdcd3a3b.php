        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; width: 100%; max-width: 600px;  " class="content">
            ...
            <tr>
                <td align="center" class="bgcolor1" style="padding: 20px 20px 20px 20px; color: #ffffff; font-family: Arial, sans-serif; font-size: 36px; font-weight: bold;">
                    <img src="<?php echo e(asset('media/tum-logo/tum-logo.png')); ?>" alt="" width="160" height="152" style="display:block;" />
                </td>
            </tr>
            <tr>
                <td align="auto" class="bgcolor2" style="padding: 40px 20px 40px 20px; color: #555555; font-family: Arial, sans-serif; font-size: 20px; line-height: 30px; border-bottom: 1px solid #f6f6f6;">
                    <h5>Dear <?php echo e($approval->studentLeave->sname.' '.$approval->studentLeave->fname.' '.$approval->studentLeave->mname); ?> , </h5>
                     <p>
                       Your academic leave/deferment has been accepted, it starts from
                        <b><?php echo e($approval->from); ?></b> to <b><?php echo e($approval->to); ?></b>. You will join <b><?php echo e($approval->deferredClass->deferred_class); ?></b> at this academic year <b><?php echo e($approval->deferredClass->academic_year); ?></b> and this acedimic semester <b><?php echo e($approval->deferredClass->semester_study); ?></b> at stage <b><?php echo e($approval->deferredClass->stage); ?></b>.
                     </p>
                    <div>
                        <p>
                            <b>
...
</html><?php /**PATH /var/www/html/Courses/application/Modules/Registrar/Resources/views/leaves/leaveAcceptedMail.blade.php ENDPATH**/ ?>