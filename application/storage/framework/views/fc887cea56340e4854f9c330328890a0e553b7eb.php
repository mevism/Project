                        ...
                        <?php if(count($apps)>0): ?>
                            ...
                            <?php $__currentLoopData = $apps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $app): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <input class="batch" type="checkbox" name="submit[]" value="<?php echo e($app->id); ?>">
                                        <?php else: ?>
                                        ✔
                                    <?php endif; ?>
                                    </td>
...
<?php echo $__env->make('applications::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\smis\application\Modules/Finance\Resources/views/applications/batch.blade.php ENDPATH**/ ?>