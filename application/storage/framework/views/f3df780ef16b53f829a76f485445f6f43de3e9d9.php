                ...
                <table id="example"  class="table table-sm table-striped table-bordered fs-sm">
                    ...
                    <?php $__currentLoopData = $transfers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $transfer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <?php echo e($transfer->courseTransfer); ?> | <?php echo e($transfer->classTransfer->points); ?>

                            </td>
                            <td nowrap="">
                                <?php if($transfer->status === NULL): ?>
                            ...
                            <td nowrap="">
                                <?php if($transfer->status === NULL): ?>
                                    ...
                                    <a class="btn btn-sm btn-alt-success" href="<?php echo e(route('student.storetransferrequest', ['id' => Crypt::encrypt($transfer->id)])); ?>" >Submit</a> |
                                    <a class="btn btn-sm btn-alt-info" href="<?php echo e(route('student.edittransferrequest', ['id' => Crypt::encrypt($transfer->id)])); ?>" >Edit</a> |
                                    <a class="btn btn-sm btn-alt-danger" href="<?php echo e(route('student.deletetransferrequest', ['id' => Crypt::encrypt($transfer->id)])); ?>" >Delete</a>
...
<?php echo $__env->make('student::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\smis\application\Modules/Student\Resources/views/courses/transfers.blade.php ENDPATH**/ ?>