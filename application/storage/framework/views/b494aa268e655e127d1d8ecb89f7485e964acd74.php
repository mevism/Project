    ...
    <div class="content">
        ...
        <div class="row">
            <div class="col-6 col-md-3 col-lg-6 col-xl-3">
                <a class="block block-rounded block-link-pop border-start border-dark border-4" href="<?php echo e(route('student.mycourses')); ?>">
            ...
            <div class="col-6 col-md-3 col-lg-6 col-xl-3">
                <a class="block block-rounded block-link-pop border-start border-dark border-4" href="<?php echo e(route('student.unitregistration')); ?>">
                    <div class="block-content block-content-full">
            ...
            <div class="col-6 col-md-3 col-lg-6 col-xl-3">
                <a class="block block-rounded block-link-pop border-start border-dark border-4" disabled=" " href=" <?php echo e(route('student.feesstatement')); ?>">
                    <div class="block-content block-content-full">
            ...
            <div class="col-6 col-md-3 col-lg-6 col-xl-3">
                <a class="block block-rounded block-link-pop border-start border-dark border-4" href="<?php echo e(route('student.examresults')); ?>">
                    <div class="block-content block-content-full">
            ...
            <div class="col-6 col-md-3 col-lg-6 col-xl-3">
                <a class="block block-rounded block-link-pop border-start border-dark border-4" href="<?php echo e(route('student.myCalendar')); ?>">
                    <div class="block-content block-content-full">
            ...
            <div class="col-6 col-md-3 col-lg-6 col-xl-3">
                <a class="block block-rounded block-link-pop border-start border-dark border-4" href="<?php echo e(route('student.requestacademicleave')); ?>">
                    <div class="block-content block-content-full">
            ...
            <div class="col-6 col-md-3 col-lg-6 col-xl-3">
                <a class="block block-rounded block-link-pop border-start border-dark border-4" href="<?php echo e(route('student.requestreadmission')); ?>">
                    <div class="block-content block-content-full">
...
<?php echo $__env->make('student::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\smis\application\Modules/Student\Resources/views/student/index.blade.php ENDPATH**/ ?>