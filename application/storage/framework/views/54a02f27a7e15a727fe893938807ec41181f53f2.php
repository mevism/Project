                        ...
                        <?php if(count($applicant)>0): ?>
                            ...
                            <?php $__currentLoopData = $applicant; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $app): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td nowrap="">
                                        <?php if($app->applicant->student_type === 2): ?>
                                            <?php if($app->approveAdm === NULL): ?>
                                                <a class="btn btn-sm btn-alt-info" onclick="return confirm('Are you sure you want to approve?')" data-toggle="click-ripple" href="<?php echo e(route('cod.acceptAdmission', $app->id)); ?>">Accept</a>
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="block block-rounded block-transparent mb-0">
                                                                <div class="block-header block-header-default">
                                                                    <h3 class="block-title">Reason(s) for rejecting <?php echo e($app->applicant->sname); ?>'s admission</h3>
                                            ...
                                            <?php elseif($app->approveAdm->cod_status === 1): ?>
                                                <a class="btn btn-sm btn-alt-success" data-toogle="click-ripple" onclick="return confirm('Are you sure you want to submit this record?')" href="<?php echo e(route('cod.submitAdmission', $app->id)); ?>"> Submit </a>
                                                <a class="btn btn-sm btn-alt-danger m-2" href="#" data-bs-toggle="modal" data-bs-target="#modal-block-popin-<?php echo e($app->id); ?>"> Reject</a>
                                                <div class="modal fade" id="modal-block-popin-<?php echo e($app->id); ?>" tabindex="-1" role="dialog" aria-labelledby="modal-block-popin" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-popin" role="document">
                                                        <div class="modal-content">
                                        ...
                                        <?php else: ?>
                                            <?php if($app->approveAdm === NULL): ?>
                                                    <a class="btn btn-sm btn-alt-info" href="<?php echo e(route('cod.reviewAdmission', $app->id)); ?>"> Verify </a>
                                            <?php elseif($app->approveAdm->cod_status === 1): ?>
...
<?php echo $__env->make('cod::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xamp\htdocs\project\application\Modules/COD\Resources/views/admissions/index.blade.php ENDPATH**/ ?>