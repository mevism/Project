            ...
            <li class="nav-main-item">
              ...
              <div id = 'in_course'>
                  ...
                  <li class="nav-main-item<?php echo e(request()->is('academics/*') ? ' open' : ''); ?>">
                      ...
                      <ul class='nav-main-submenu'>
                          <li class='nav-main-item'>
                              <a class="nav-main-link<?php echo e(request()->is('student/exams') ? ' active' : ''); ?>" href="<?php echo e(route('change_course')); ?>">
                              <i class='nav-main-link-icon si si-user'></i>
                              <span class='nav-main-link-name'>
                                    Exams Transcripts
                                </span>
                      ...
                      <ul class='nav-main-submenu'>
                          <li class='nav-main-item'>
                              <a class="nav-main-link<?php echo e(request()->is('student/fee') ? ' active' : ''); ?>" href="<?php echo e(route('change_course')); ?>">
                              <i class='nav-main-link-icon si si-user'></i>
                              <span class='nav-main-link-name'>
                                    Fee
                                    </span>
                      ...
                      <ul class='nav-main-submenu'>
                          <li class='nav-main-item'>
                              <a class="nav-main-link<?php echo e(request()->is('student/units') ? ' active' : ''); ?>" href="<?php echo e(route('change_course')); ?>">
                              <i class='nav-main-link-icon si si-user'></i>
                              <span class='nav-main-link-name'>
                                    Units
                                    </span>
                  ...
                  <li class='nav-main-item<?php echo e(request()->is('accomodation/*') ? ' open' : ''); ?>'>
                      ...
                      <ul class='nav-main-submenu'>
                          <li class='nav-main-item'>
                              <a class="nav-main-link<?php echo e(request()->is('student/hostel') ? ' active' : ''); ?>" href="<?php echo e(route('change_course')); ?>">
                              <i class='nav-main-link-icon si si-user'></i>
                              <span class='nav-main-link-name'>
                                    Book Hostel
                                     </span>
                      ...
                      <ul class='nav-main-submenu'>
                          <li class='nav-main-item'>
                              <a class="nav-main-link<?php echo e(request()->is('student/clearing') ? ' active' : ''); ?>" href="<?php echo e(route('change_course')); ?>">
                              <i class='nav-main-link-icon si si-user'></i>
                              <span class='nav-main-link-name'>
                                        Clearing
                                    </span>
...
<?php /**PATH C:\xampp\htdocs\sims\application\Modules/Student\Resources/views/layouts/backend.blade.php ENDPATH**/ ?>