                    ...
                    <table id="example" class="table table-responsive table-md table-striped table-bordered table-vcenter fs-sm">
                        <?php if(count($admission)>0): ?>
                            ...
                            <?php $__currentLoopData = $admission; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $app): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td> <?php echo e($app->appApproval->applicant->sname); ?> <?php echo e($app->appApproval->applicant->fname); ?> <?php echo e($app->appApproval->applicant->mname); ?> </td>
                                    ...
                                    <td nowrap="">
                                        ...
                                        <?php elseif($app->admApproval->cod_status === 1): ?>
                                            ...
                                            <a class="btn btn-sm btn-alt-success" href="<?php echo e(route('cod.submitAdmission', $app->id)); ?>"> Submit </a>
                                        <?php else: ?>
                                            <a class="btn btn-sm btn-alt-info" href="<?php echo e(route('cod.reviewAdmission', $app->id)); ?>"> Edit </a>
                                        <?php endif; ?>
                                    </td>
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sims\application\Modules/Courses\Resources/views/admissions/index.blade.php ENDPATH**/ ?>