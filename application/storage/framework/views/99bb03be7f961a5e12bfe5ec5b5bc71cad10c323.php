            ...
            <div class="block-content block-content-full">
              <div class="row">
                  <div class="d-flex justify-content-center">
                   ...
                   <form class="row row-cols-lg-auto g-3 align-items-center" action="<?php echo e(route('courses.storeVoteheads')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('registrar::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Registrar/application/Modules/Registrar/Resources/views/fee/voteheads.blade.php ENDPATH**/ ?>