        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; width: 100%; max-width: 600px;  " class="content">
            ...
            <tr>
                <td align="center" bgcolor="#27ae60" style="padding: 20px 20px 20px 20px; color: #ffffff; font-family: Arial, sans-serif; font-size: 36px; font-weight: bold;">
                    <img src="<?php echo e(url('media/tum-logo/tum-logo.png')); ?>" alt="TUM" width="160" height="152" style="display:block;" />
                </td>
            </tr>
            <tr>
                    ...
                    <table bgcolor="#4CAF50" border="0" cellspacing="0" cellpadding="0" class="buttonwrapper">
                        <tr>
                            <td align="center" height="50" style=" padding: 0 25px 0 25px; font-family: Arial, sans-serif; font-size: 16px; font-weight: bold;" class="button">
                                <a type="button" data-toggle="click-ripple" href="<?php echo e(route('application.emailverification', $applicant->VerifyEmail->verification_code)); ?>" style="color: #ffffff; text-align: center; text-decoration: none;">Activate Account</a>
                            </td>
                        </tr>
                    </table>
...
</html><?php /**PATH /var/www/html/Registrar/application/Modules/Application/Resources/views/emails/verification-email.blade.php ENDPATH**/ ?>