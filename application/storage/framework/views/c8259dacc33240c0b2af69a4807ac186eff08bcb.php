          ...
          <table id="example" class="table table-bordered table-striped table-vcenter js-dataTable-responsive fs-sm">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td style="text-transform: uppercase"class="fw-semibold fs-sm"><?php echo e($class->classCourse->course_name); ?></td>
...
<?php echo $__env->make('registrar::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sims\application\Modules/Registrar\Resources/views/class/showClasses.blade.php ENDPATH**/ ?>