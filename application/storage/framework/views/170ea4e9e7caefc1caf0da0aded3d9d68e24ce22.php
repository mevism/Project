          ...
          <ul class="nav-main">
            <li class="nav-main-item">
              <a class="nav-main-link<?php echo e(request()->is('dashboard') ? ' active' : ''); ?>" href="<?php echo e(route('dashboard')); ?>">
                ...
                <span class="nav-main-link-name">
                    <?php if(auth()->guard('user')->user()->role_id == 1): ?>
                        Registrar
                    <?php endif; ?>
                </span>
            ...
            <li class="nav-main-item<?php echo e(request()->is('intakes/*') ? ' open' : ''); ?>">
              ...
              <li class="nav-main-item<?php echo e(request()->is('intakes/*') ? ' open' : ''); ?>">
                ...
                <ul class="nav-main-submenu">
                    <li class="nav-main-item">
                        <a class="nav-main-link<?php echo e(request()->is('transfer') ? ' active' : ''); ?>" href="<?php echo e(route('courses.transfer')); ?>">
                            <i class="nav-main-link-icon si si-user"></i>
...
<?php /**PATH /var/www/html/Registrar/application/Modules/Registrar/Resources/views/layouts/backend.blade.php ENDPATH**/ ?>