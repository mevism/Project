                    ...
                    <tbody>
                        <?php $__currentLoopData = $leaves; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $academicYear => $leave): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-sm btn-outline-dark" href="<?php echo e(route('dean.yearlyLeaves', ['year' => Crypt::encrypt($academicYear)])); ?>"> View </a>
                                </td>
                            </tr>
...
<?php echo $__env->make('dean::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Courses/application/Modules/Dean/Resources/views/defferment/index.blade.php ENDPATH**/ ?>