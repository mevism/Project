        ...
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-0">
                <div class="flex-grow-0">
                    ...
                    <?php echo e($year); ?> COURSE TRANSFER REQUESTS
                    </h5>
                </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="d-flex justify-content-end m-2">
                        <a class="btn  btn-alt-primary btn-sm" href="<?php echo e(route('courses.requestedTransfers', ['year' => Crypt::encrypt($year)])); ?>">Generate report</a>
                    </div>
