                    ...
                    <div class="tab-content col-md-9">
                        <div class="block-content tab-pane active" id="btabs-vertical-course" role="tabpanel" aria-labelledby="btabs-vertical-home-course">
                            ...
                            <div class="row my-2">
                                ...
                                <div class="form-floating col-sm-8 text-uppercase py-1">
                                    <input type="text" class="form-control form-control-sm" name="course" value="<?php echo e($course->mainCourses->course_name); ?>" readonly>
                                </div>
                            </div>
                            <div class="row my-2">
                                <label class="col-sm-2 col-form-label" for="example-hf-email">Department</label>
                                <div class="form-floating col-sm-8 text-uppercase py-1">
                                    <input type="text" class="form-control form-control-sm" name="department" value="<?php echo e($course->mainCourses->department_id); ?>" readonly>
                                </div>
                            </div>
                            <div class="row my-2">
                                <label class="col-sm-2 col-form-label" for="example-hf-email">School</label>
                                <div class="form-floating col-sm-8 text-uppercase py-1">
                                    <input type="text" class="form-control form-control-sm" name="school" value="<?php echo e($course->mainCourses->school_id); ?>" readonly>
                                    ...
                                    <div class="space-x-1">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="campus" value="Main"
                                                   <?php if($mycourse != null): ?> <?php echo e(($mycourse->campus == 'Main')? "checked" : ""); ?><?php endif; ?>
                                                   <?php if(old('campus') === 'Main'): ?> checked <?php endif; ?> required>
                                            <label class="form-check-label">Main</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="campus" value="Kwale"
                                                   <?php if($mycourse != null): ?> <?php echo e(($mycourse->campus == 'Kwale')? "checked" : ""); ?><?php endif; ?>
                                                   <?php if(old('campus') === 'Kwale'): ?>  checked <?php endif; ?> required>
                                            <label class="form-check-label">Kwale</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="campus" value="Lamu"
                                                   <?php if($mycourse != null): ?> <?php echo e(($mycourse->campus == 'Lamu')? "checked" : ""); ?><?php endif; ?>
                                                   <?php if(old('campus') === 'Lamu'): ?> checked <?php endif; ?> required>
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-sm-8 text-uppercase py-1">
                                    <div class="form-floating input-group">
                                        <span class="input-group-text input-group-text-sm"><?php echo e(Str::limit( $course->mainCourses->subject1, $limit = 3 , $end='' )); ?></span>
                                        <input type="text" class="form-control form-control-sm" <?php if($mycourse != null && $mycourse->declaration === 1): ?> disabled <?php endif; ?> name="subject1" value="<?php echo e(old('subject1')); ?> <?php if($mycourse != null): ?> <?php echo e($mycourse->subject_1); ?> <?php endif; ?> ">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row my-2">
                                ...
                                <div class="col-sm-8 text-uppercase py-1">
                                    <div class="form-floating input-group">
                                        <span class="input-group-text input-group-text-sm"><?php echo e(Str::limit( $course->mainCourses->subject2, $limit = 3 , $end='' )); ?></span>
                                        <input type="text" class="form-control form-control-sm" <?php if($mycourse != null && $mycourse->declaration === 1): ?> disabled <?php endif; ?> name="subject2" value="<?php echo e(old('subject2')); ?> <?php if($mycourse != null): ?> <?php echo e($mycourse->subject_2); ?> <?php endif; ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row my-2">
                                ...
                                <div class="form-floating col-sm-8 text-uppercase py-1">
                                    <div class="form-floating input-group">
                                        <span class="input-group-text input-group-text-sm"><?php echo e(Str::limit( $course->mainCourses->subject3, $limit = 8 , $end='' )); ?></span>
                                        <input type="text" class="form-control form-control-sm" <?php if($mycourse != null && $mycourse->declaration === 1): ?> disabled <?php endif; ?>  name="subject3" value="<?php echo e(old('subject3')); ?> <?php if($mycourse != null): ?> <?php echo e($mycourse->subject_3); ?> <?php endif; ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row my-2">
                                ...
                                <div class="col-sm-8 text-uppercase py-1">
                                    <div class="form-floating input-group">
                                        <span class="input-group-text input-group-text-sm"><?php echo e(Str::limit( $course->mainCourses->subject4, $limit = 8 , $end='' )); ?></span>
                                        <input type="text" class="form-control form-control-sm" <?php if($mycourse != null && $mycourse->declaration === 1): ?> disabled <?php endif; ?> name="subject4" value="<?php echo e(old('subject4')); ?> <?php if($mycourse != null): ?> <?php echo e($mycourse->subject_4); ?> <?php endif; ?>">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="block-content tab-pane" id="btabs-vertical-fee" role="tabpanel" aria-labelledby="btabs-vertical-fee-tab">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="py-2 mb-0">
                                        You are required to pay <span class="fw-bold">Ksh. <?php echo e($course->mainCourses->fee); ?> </span> to complete this application.
                            ...
                            <div class="block-content-full">
                                    <div class="p-sm-2 p-xl-12">
                                        <div class="row mb-2 text-center">
                                            <span class="fw-semibold mb-2"> <?php echo e($course->mainCourses->school_id); ?> </span>
                                            <span class="fw-semibold mb-2"> <?php echo e($course->mainCourses->department_id); ?></span>
                                        ...
                                        <table class="table table-sm table-bordered table-striped table-responsive-md">
                                            ...
                                            <?php endif; ?>
                                                <?php if($mycourse != null): ?>
                                                    ...
                                                    <tbody>
                                                        <td colspan="2"> <?php echo e($course->mainCourses->course_requirements); ?> </td>
                                                    </tbody>
                                                <?php endif; ?>
                                            <?php if($mycourse != null): ?>
                                                        <thead>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td><?php echo e($course->mainCourses->subject1); ?></td>
                                                            <td><?php echo e($mycourse->subject_1); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td><?php echo e($course->mainCourses->subject2); ?></td>
                                                            <td><?php echo e($mycourse->subject_2); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td><?php echo e($course->mainCourses->subject3); ?></td>
                                                            <td><?php echo e($mycourse->subject_3); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td><?php echo e($course->mainCourses->subject4); ?></td>
...
<?php echo $__env->make('application::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xamp\htdocs\courses\project\application\Modules/Application\Resources/views/applicant/application.blade.php ENDPATH**/ ?>