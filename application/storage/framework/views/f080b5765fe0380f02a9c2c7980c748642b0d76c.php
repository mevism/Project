    ...
    <div class="content">
        ...
        <div class="d-flex justify-content-center py-1">
            <?php if($app->finance_status === 0): ?>
                <a class="btn btn-sm btn-alt-success m-2" data-toggle="click-ripple" href="<?php echo e(route('finance.acceptApplication', $app->id)); ?>">Accept</a>
...
<?php echo $__env->make('applications::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Registrar/application/Modules/Finance/Resources/views/applications/viewApplication.blade.php ENDPATH**/ ?>