                                ...
                                <tbody>
                                    <?php $__currentLoopData = $patterns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $pattern): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-sm btn-outline-primary" href="<?php echo e(route('department.viewSemesterUnits', ['id' => Crypt::encrypt($pattern->id)])); ?>">view units</a>
                                            </td>
...
<?php echo $__env->make('cod::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Courses/application/Modules/COD/Resources/views/classes/classPattern.blade.php ENDPATH**/ ?>