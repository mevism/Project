    ...
    <div class="block block-rounded">
        <div class="block-content block-content-full">
            <div class="d-flex justify-content-center">
                ...
                <form method="POST" action="<?php echo e(route('department.submitResults')); ?>">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="form-floating mb-2">
                            <select name="student" class="form-control form-select">
                                ...
                                <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($student->id); ?>"> <?php echo e($student->reg_number); ?> <?php echo e($student->sname.' '.$student->fname.' '.$student->mname); ?></option>
...
<?php echo $__env->make('cod::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\smis\application\Modules/COD\Resources/views/exams/addExam.blade.php ENDPATH**/ ?>