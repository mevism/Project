      ...
      <div class="content-header border-bottom">
        ...
        <div class="ms-2">
          <a class="text-dark fw-semibold fs-sm" href="javascript:void(0)">
              <?php if(auth()->guard('web')->user()->infoApplicant != null): ?>
              <?php echo e(auth()->guard('web')->user()->infoApplicant->name); ?></a>
            <?php endif; ?>
        </div>
        <!-- END User Info -->
          ...
          <ul class="nav-main">
            ...
            <li class="nav-main-item<?php echo e(request()->is('pages/*') ? ' open' : ''); ?>">
              ...
              <li class="nav-main-item<?php echo e(request()->is('pages/*') ? ' open' : ''); ?>">
                  ...
                  <ul class="nav-main-submenu">
                      <li class="nav-main-item">
                          <a class="nav-main-link<?php echo e(request()->is('pages/datatables') ? ' active' : ''); ?>" href="<?php echo e(route('application.myAdmission')); ?>">
        ...
        <div class="d-flex align-items-center">
          ...
          <div class="dropdown d-inline-block ms-2">
            <button type="button" class="btn btn-sm btn-alt-dark d-flex align-items-center" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <img class="rounded-circle" src="<?php echo e(asset('media/avatars/avatar14.jpg')); ?>" alt="Header Avatar" style="width: 21px;">
              <span class="d-none d-sm-inline-block ms-2">
                  <?php if(auth()->guard('web')->user()->infoApplicant != null): ?>
                  <?php echo e(auth()->guard('web')->user()->infoApplicant->title); ?> <?php echo e(auth()->guard('web')->user()->infoApplicant->surname); ?>
            ...
            <div class="dropdown-menu dropdown-menu-md dropdown-menu-end p-0 border-0" aria-labelledby="page-header-user-dropdown">
              <div class="p-3 text-center bg-body-light border-bottom rounded-top">
                <img class="img-avatar img-avatar48 img-avatar-thumb" src="<?php echo e(asset('media/avatars/avatar14.jpg')); ?>" alt="">
                <p class="mt-2 mb-0 fw-medium">
                    <?php if(auth()->guard('web')->user()->infoApplicant != null): ?>
                    <?php echo e(auth()->guard('web')->user()->infoApplicant->first_name); ?> <?php echo e(auth()->guard('web')->user()->infoApplicant->middle_name); ?> <?php echo e(auth()->guard('web')->user()->infoApplicant->surname); ?>
...
<?php /**PATH C:\xampp\htdocs\smis\application\Modules/Application\Resources/views/layouts/backend.blade.php ENDPATH**/ ?>