          ...
          <div class="dropdown d-inline-block ms-2">
            <button type="button" class="btn btn-sm btn-alt-dark d-flex align-items-center" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              ...
              <span class="d-none d-sm-inline-block ms-2">
                  <?php if(auth()->guard('web')->user()->infoApplicant != null): ?>
                  <?php echo e(auth()->guard('web')->user()->infoApplicant->title); ?> <?php echo e(auth()->guard('web')->user()->infoApplicant->sname); ?>
            ...
            <div class="dropdown-menu dropdown-menu-md dropdown-menu-end p-0 border-0" aria-labelledby="page-header-user-dropdown">
              <div class="p-3 text-center bg-body-light border-bottom rounded-top">
                ...
                <p class="mt-2 mb-0 fw-medium">
                    <?php if(auth()->guard('web')->user()->infoApplicant != null): ?>
                    <?php echo e(auth()->guard('web')->user()->infoApplicant->fname); ?> <?php echo e(auth()->guard('web')->user()->infoApplicant->mname); ?> <?php echo e(auth()->guard('web')->user()->infoApplicant->sname); ?>
