                            ...
                            <?php $__currentLoopData = $admission; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $app): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    ...
                                    <td nowrap="">
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="block block-rounded block-transparent mb-0">
                                                            ...
                                                            <div class="block-content fs-sm">
                                                                <form action="<?php echo e(route('courses.rejectAdmissions', $app->id)); ?>" method="post">
                                                                    <?php echo csrf_field(); ?>
                                        ...
                                        <?php elseif($app->registrar_status == 1): ?>
                                            <a class="btn btn-sm btn-alt-info disabled" href="<?php echo e(route('cod.reviewAdmission', $app->id)); ?>"> Edit </a>
                                        <?php else: ?>
                                            <a class="btn btn-sm btn-alt-info disabled" href="<?php echo e(route('cod.reviewAdmission', $app->id)); ?>"> Edit </a>
                                        <?php endif; ?>
                                    </td>
