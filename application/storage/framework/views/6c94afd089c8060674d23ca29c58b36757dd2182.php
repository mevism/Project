            ...
            <div class="block-content block-content-full">
              <div class="row">
                <div class="col-lg-12 space-y-0">
                   ...
                   <form action="<?php echo e(route('courses.storeIntake')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('registrar::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sims\application\Modules/Registrar\Resources/views/intake/addIntake.blade.php ENDPATH**/ ?>