                        ...
                        <div class="content content-full">
                            <div class="row g-0 justify-content-center">
                                <div class="col-md-8 col-lg-6 col-xl-4 py-4 px-4 px-lg-5">
                                    ...
                                    <form class="js-validation-signup" action="<?php echo e(route('payment.register')); ?>" method="GET">
                                        <?php echo csrf_field(); ?>
                                        <div class="py-3">
...
<?php echo $__env->make('epayment::layouts.simple', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\smis\application\Modules/Epayment\Resources/views/index.blade.php ENDPATH**/ ?>