                    ...
                    <table id="example" class="table table-md table-striped table-bordered table-vcenter fs-sm">
                        <?php if(count($apps)>0): ?>
                            ...
                            <tr>
                                ...
                                <td nowrap="">
                                <?php if($app->dean_status == 0): ?>
                                    <a class="btn btn-sm btn-alt-secondary" href="<?php echo e(route('dean.viewApplication', [ 'id' => Crypt::encrypt($app->id)])); ?>"> View </a>
                                <?php else: ?>
                                    <a class="btn btn-sm btn-alt-secondary" href="<?php echo e(route('dean.previewApplication', [ 'id' => Crypt::encrypt($app->id)])); ?>"> View </a>
                                    <a class="btn btn-sm btn-alt-info" href="<?php echo e(route('dean.viewApplication', [ 'id' => Crypt::encrypt($app->id)])); ?>"> Edit </a>
                                <?php endif; ?>
                                </td>
                            </tr>
...
<?php echo $__env->make('dean::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Registrar/application/Modules/Dean/Resources/views/applications/index.blade.php ENDPATH**/ ?>