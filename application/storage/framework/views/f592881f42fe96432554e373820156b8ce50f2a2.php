...
<script>
   $(document).ready(function() {
        ...
        $('#select2').on('change', function (){
            ...
            $.ajax({
                type: 'get',
                url: '<?php echo e(route('finance.getInvoiceType')); ?>',
                data: { code:code },
                dataType: 'json',
...
<?php echo $__env->make('applications::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\smis\application\Modules/Finance\Resources/views/invoices/addInvoice.blade.php ENDPATH**/ ?>