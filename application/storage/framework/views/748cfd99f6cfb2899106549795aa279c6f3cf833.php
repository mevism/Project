            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="d-flex justify-content-center m-2">
                            ...
                            <a class="btn btn-outline-success col-md-2 m-2" href="<?php echo e(route('dean.acceptLeaveRequest', ['id' => Crypt::encrypt($leave->id)])); ?>"> Accept Transfer </a>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="<?php echo e(route('dean.declineLeaveRequest', ['id' => Crypt::encrypt($leave->id)])); ?>">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('dean::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Courses/application/Modules/Dean/Resources/views/defferment/viewRequests.blade.php ENDPATH**/ ?>