            ...
            <div class="row row-cols-sm-2 g-2">
                ...
                <div class="">
                    ...
                    <div class="mb-2">
                        ...
                        <span class="h6 fs-sm fw-normal"> <?php echo e($reg->year_study); ?></span>

                        <span class="h5 fs-sm"> SEMESTER OF STUDY : </span>
                        <span class="h6 fs-sm fw-normal"> <?php echo e($reg->semester_study); ?> (<?php echo e($reg->patternRoll->season); ?>)</span>

                        <span class="h5 fs-sm"> ACADEMIC YEAR : </span>
                        <span class="h6 fs-sm fw-normal"> <?php echo e($reg->academic_year); ?></span>
                        <?php endif; ?>
                    </div>
                    </fieldset>
                </div>
                            ...
                            <div class="row row-cols-sm-3 g-1 fs-sm">
                                ...
                                <fieldset class="border p-2 mb-0">
                                    ...
                                    <?php $__currentLoopData = $units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $one): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <p> <?php echo e(++$key); ?>. <?php echo e($one->course_unit_code); ?> - <?php echo e($one->unit_name); ?></p>
...
<?php echo $__env->make('student::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Registrar/application/Modules/Student/Resources/views/semester/requestRegistration.blade.php ENDPATH**/ ?>