                    ...
                    <table id="example" class="table table-responsive table-md table-striped table-bordered table-vcenter fs-sm">
                            ...
                            <?php $__currentLoopData = $applicant; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $app): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php if($app->appApprovals->applicant->student_type == 1): ?>
                                            S-FT
                                        <?php elseif($app->appApprovals->applicant->student_type == 2): ?>
                                            J-FT
                                        <?php else: ?>
                                            S-PT
                                        <?php endif; ?>
                                    ...
                                    <td nowrap="">
                                            <?php if($app->finance_status== 0): ?>
                                                <a class="btn btn-sm btn-alt-info" data-toogle="click-ripple" href="<?php echo e(route('finance.reviewAdmission', ['id' => Crypt::encrypt($app->id)])); ?>"> verify</a>
                                            <?php elseif($app->finance_status== 1): ?>
                                                <a class="btn btn-sm btn-alt-success" data-toogle="click-ripple" onclick="return confirm('Are you sure you want to submit this record?')" href="<?php echo e(route('finance.submitAdmission', ['id' => Crypt::encrypt($app->id)])); ?>"> submit</a>
                                                <a class="btn btn-sm btn-alt-primary" data-toogle="click-ripple" href="<?php echo e(route('finance.reviewAdmission', ['id' => Crypt::encrypt($app->id)])); ?>"> edit</a>
                                            <?php else: ?>
                                                <a class="btn btn-sm btn-alt-primary" data-toogle="click-ripple" href="<?php echo e(route('finance.reviewAdmission', ['id' => Crypt::encrypt($app->id)])); ?>"> edit</a>
                                            <?php endif; ?>
                                    </td>
