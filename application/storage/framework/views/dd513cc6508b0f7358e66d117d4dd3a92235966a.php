            ...
            <li class="nav-main-item">
              ...
              <div id = 'in_course'>
                  ...
                  <li class='nav-main-item<?php echo e(request()->is('academics/*') ? ' open' : ''); ?>'>
                      ...
                      <ul class='nav-main-submenu'>
                          <li class='nav-main-item'>
                              <a class='nav-main-link<?php echo e(request()->is('student/change_course') ? 'active' : ''); ?> href='". route('change_course') }}'>
                              <i class='nav-main-link-icon si si-user'></i>
                              <span class='nav-main-link-name'>
                                    Fee
                                    </span>
...
<?php /**PATH /var/www/html/Sims/application/Modules/Student/Resources/views/layouts/backend.blade.php ENDPATH**/ ?>