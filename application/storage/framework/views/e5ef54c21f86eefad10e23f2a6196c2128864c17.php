              ...
              <a class="nav-main-link<?php echo e(request()->is('dashboard') ? ' active' : ''); ?>" href="<?php echo e(route('dashboard')); ?>">
                ...
                <span class="nav-main-link-name">
                    <?php if(auth()->guard('user')->user()->hasRole('REGISTRAR')): ?>
                        Registrar [ <?php echo e(auth()->guard('user')->user()->employmentDepartment->first()->dept_code); ?> ]
                    <?php endif; ?>
                </span>
              </a>
            </li>
...
<?php /**PATH C:\xampp\htdocs\smis\application\Modules/Registrar\Resources/views/layouts/backend.blade.php ENDPATH**/ ?>