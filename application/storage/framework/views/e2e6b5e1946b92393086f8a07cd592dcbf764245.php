...
<script type="module">
    ...
    $(document).ready(function() {
        ...
        function negativeValueRenderer(instance, td, row, col, prop, value, cellProperties, ) {
            ...
            if (!value || value === '' || value == null, value === '0' || value === 'ABSENT') {
...
<?php echo $__env->make('lecturer::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\project\application\Modules/Lecturer\Resources/views/examination/editExam.blade.php ENDPATH**/ ?>