          ...
          <table id="example" class="table table-sm table-bordered table-striped fs-sm">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td> <?php echo e($department->deptSchool->name); ?></td>
                <td> <?php echo e($department->name); ?></td>
                <td> <?php echo e($department->dept_code); ?> </td>
                  <td> <?php echo e(strtoupper($department->deptDivision->name)); ?> </td>
                  <td>
...
<?php echo $__env->make('registrar::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\smis\application\Modules/Registrar\Resources/views/department/showDepartment.blade.php ENDPATH**/ ?>