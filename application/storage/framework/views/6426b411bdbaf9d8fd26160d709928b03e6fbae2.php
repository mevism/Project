                                        ...
                                        <tr>
                                            ...
                                            <td nowrap>
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    <?php elseif($workload->dean_status === 1 && $workload->registrar_status === 0 && $workload->status === null): ?>
                                                    <a class="btn btn-outline-info btn-sm" href=""> processing </a>

                                                    <?php elseif($workload->dean_status === 2 && $workload->registrar_status === null && $workload->workloadProcessed->first()->status === null): ?> 
                                                    ...
                                                    <?php elseif($workload->dean_status === 2 && $workload->workloadProcessed->first()->status === 0): ?>   
...
<?php echo $__env->make('dean::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Work/Tum/Project/application/Modules/Dean/Resources/views/workload/index.blade.php ENDPATH**/ ?>