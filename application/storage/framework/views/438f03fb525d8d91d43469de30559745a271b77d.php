        ...
        <table id="example" class="table table-bordered table-striped table-sm fs-sm">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a class="btn btn-sm btn-alt-secondary" href="<?php echo e(route('courses.coursePreview', $courses->course_id)); ?>"> View </a>
              </td>
              <td nowrap="">
                <a class="btn btn-sm btn-alt-info" href="<?php echo e(route('courses.editCourse', $courses->course_id )); ?>">edit</a>
