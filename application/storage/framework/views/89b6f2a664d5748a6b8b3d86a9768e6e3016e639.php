            ...
            <tbody>
              ...
              <tr>
                ...
                <td> 
                  ...
                  <a class="btn btn-sm btn-alt-danger" onclick="return confirm('Are you sure you want to delete this attendance mode  ?')" href="<?php echo e(route('courses.destroyAttendance', $attendance->id)); ?>">delete</a> 
                </td>
              </tr>
...
<?php echo $__env->make('registrar::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sims\application\Modules/Registrar\Resources/views/attendance/showAttendance.blade.php ENDPATH**/ ?>