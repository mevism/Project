        ...
        <div class="block block-rounded">
            ...
            <div class="d-flex justify-content-center py-1">
                ...
                <?php if($app->approveAdm->cod_status == 0): ?>
                    <a class="btn btn-sm btn-alt-success m-2" data-toggle="click-ripple" href="<?php echo e(route('cod.acceptAdmission', ['id' => Crypt::encrypt($app->id)])); ?>"> Accept </a>
            ...
            <div class="modal-content">
                <div class="block block-rounded block-transparent mb-0">
                    ...
                    <div class="block-content fs-sm">
                        <form action="<?php echo e(route('cod.rejectAdmission', ['id' => Crypt::encrypt($app->id)])); ?>" method="post">
                            <?php echo csrf_field(); ?>
    ...
    <div class="modal fade" id="modal-block-popin1" tabindex="-1" role="dialog" aria-labelledby="modal-block-popin" aria-hidden="true">
        <div class="modal-dialog modal-dialog-popin" role="document">
            <div class="modal-content">
                <div class="block block-rounded block-transparent mb-0">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">Reason(s) for withholding <?php echo e($app->applicant->sname); ?>'s admission</h3>
                        <div class="block-options">
                            <button type="button" class="btn-block-option" data-bs-dismiss="modal" aria-label="Close">
                                <i class="fa fa-fw fa-times"></i>
                            </button>
                    ...
                    <div class="block-content fs-sm">
                        <form action="<?php echo e(route('cod.withholdAdmission', ['id' => Crypt::encrypt($app->id)])); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            <div class="row col-md-12 mb-3">
                                <div class="d-flex justify-content-center">
...
<?php echo $__env->make('cod::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Registrar/application/Modules/COD/Resources/views/admissions/review.blade.php ENDPATH**/ ?>