...
<?php $__env->startSection('content'); ?>
        <!-- Hero -->
        <div class="bg-image" style="background-image: <?php echo e(url('media/photos/photo10@2x.jpg')); ?>;">
            <div class="bg-primary-dark-op">
                <div class="content content-full text-center">


                        <?php if($user->loggedStudent->ID_photo == NULL): ?>
                            <?php if($user->loggedStudent->gender == 'M'): ?>
                            <div class="my-3">
                                <img class="img-avatar img-avatar-thumb" src="<?php echo e(url('media/avatars/male.jpg')); ?>" alt="">
                            </div>
                            <?php else: ?>
                            <div class="my-3">
                                <img class="img-avatar img-avatar-thumb" src="<?php echo e(url('media/avatars/female.jpg')); ?>" alt="">
                            </div>
                            <?php endif; ?>
                        <?php else: ?>
                            <div class="my-3">
                        ...
                        <?php endif; ?>
                    <h2 class="h4 fw-normal text-white-75 mt-4">
                        <?php echo e($user->loggedStudent->title); ?> <?php echo e($user->loggedStudent->sname); ?> <?php echo e($user->loggedStudent->fname); ?> <?php echo e($user->loggedStudent->mname); ?>
...
<?php echo $__env->make('student::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\project\application\Modules/Student\Resources/views/student/profile.blade.php ENDPATH**/ ?>