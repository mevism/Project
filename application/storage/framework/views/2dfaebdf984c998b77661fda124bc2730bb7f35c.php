                    ...
                    <div class="col-lg-6 space-y-0">
                       <form class="row row-cols-lg-auto g-3 align-items-center" action="<?php echo e(route('courses.storeAttendance')); ?>" method="POST">
                        ...
                        <div class="form-floating col-12 col-xl-12">
                          <input type="text" class="form-control form-control-alt" value="<?php echo e(old('name')); ?>"id="name" name="name" placeholder="Name">
                          <label class="form-label">MODE OF STUDY</label>
                        </div>
                        <div class="form-floating col-12 col-xl-12">
                          <input type="text" class="form-control form-control-alt"  value="<?php echo e(old('code')); ?>"id="code" name="code" placeholder="Code">
...
<?php echo $__env->make('registrar::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Registrar/application/Modules/Registrar/Resources/views/attendance/addAttendance.blade.php ENDPATH**/ ?>