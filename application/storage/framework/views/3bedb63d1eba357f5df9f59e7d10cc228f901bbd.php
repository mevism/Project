    ...
    <div class="block block-bordered">
        <div class="block-content block-content-full">
                    ...
                    <tr>
                        ...
                        <td>
                            <form method="POST" action="<?php echo e(route('application.academicDoc')); ?>" enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="academicDocId" value="<?php echo e($admission->application_id); ?>">
                    ...
                    <tr>
                        ...
                        <td>
                            <form method="POST" action="<?php echo e(route('application.bankReceipt')); ?>" enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="bankReceiptId" value="<?php echo e($admission->application_id); ?>">
                                <button type="submit" class="btn btn-sm btn-success" <?php if($admission->admissionDoc != null && $admission->admissionDoc->status == 1): ?> disabled <?php endif; ?> ><i class="fa fa-file-upload"></i> upload</button>
                            </form>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <form method="POST" action="<?php echo e(route('application.medicalForm')); ?>" enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="medicalFormId" value="<?php echo e($admission->application_id); ?>">
                                <button type="submit" class="btn btn-sm btn-success" <?php if($admission->admissionDoc != null && $admission->admissionDoc->status == 1): ?> disabled <?php endif; ?> ><i class="fa fa-file-upload"></i> upload</button>
                            </form>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <form method="POST" action="<?php echo e(route('application.passportPhoto')); ?>" enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="passPortId" value="<?php echo e($admission->application_id); ?>">
                                <button type="submit" class="btn btn-sm btn-success" <?php if($admission->admissionDoc != null && $admission->admissionDoc->status == 1): ?> disabled <?php endif; ?> ><i class="fa fa-file-upload"></i> upload</button>
                            </form>
                        </td>
                        <td>
            ...
            <div class="d-flex justify-content-center m-3">
                <a class="btn btn-sm btn-alt-success" data-toggle="click-ripple" onclick="return confirm('You are about to submit your documents. Once submitted cannot be changed. Are you sure you want to proceed?')" href="<?php echo e(route('application.submitDocuments', $admission->application_id)); ?>">Submit documents</a>
            </div>
                    <?php else: ?>
...
<?php echo $__env->make('application::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\smis\application\Modules/Application\Resources/views/applicant/admission.blade.php ENDPATH**/ ?>