                      ...
                      <div class="col-12">                
                        ...
                        <div class="col-12">
                         <select name="status"  class="form-control form-control-alt">
                             <option disabled value="<?php echo e($data->status); ?>" class="form-select">
...
<?php echo $__env->make('registrar::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Registrar/application/Modules/Registrar/Resources/views/intake/editstatusIntake.blade.php ENDPATH**/ ?>