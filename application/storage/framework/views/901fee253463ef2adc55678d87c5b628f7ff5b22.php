                ...
                <div class="block block-rounded row g-0">
                    <ul class="nav nav-tabs nav-tabs-block flex-md-column col-md-3" role="tablist">
                        <li class="nav-item d-md-flex flex-md-column">
                            <button class="nav-link text-md-start <?php if($mycourse == null): ?> active <?php endif; ?>  " id="btabs-vertical-require-tab" data-bs-toggle="tab" data-bs-target="#btabs-vertical-require" role="tab" aria-controls="btabs-vertical-require" aria-selected="false">
                        ...
                        <li class="nav-item d-md-flex flex-md-column">
                            <button class="nav-link text-md-start <?php if(count($education) <= 0 && $mycourse != null): ?> active <?php endif; ?> " id="btabs-vertical-education-tab" data-bs-toggle="tab" data-bs-target="#btabs-vertical-education" role="tab" aria-controls="btabs-vertical-education" aria-selected="false">
                        ...
                        <li class="nav-item d-md-flex flex-md-column">
                            <button class="nav-link text-md-start" id="btabs-vertical-fee-tab" data-bs-toggle="tab" data-bs-target="#btabs-vertical-fee" role="tab" aria-controls="btabs-vertical-fee" aria-selected="false">
                                ...
                                <?php if($mycourse != null && $mycourse->applicationApproval != null && $mycourse->applicationApproval->finance_status == 1): ?>
                                    <span class="badge bg-success"><i class="fa fa-check-circle"></i> Complete </span>
                                <?php else: ?>
                        ...
                        <li class="nav-item d-md-flex flex-md-column">
                            <button class="nav-link text-md-start <?php if($mycourse != null && $mycourse->applicationApproval == null && count($education) > 0): ?> active <?php endif; ?> " id="btabs-vertical-submit-tab" data-bs-toggle="tab" data-bs-target="#btabs-vertical-submit" role="tab" aria-controls="btabs-vertical-submit" aria-selected="false">
                                <i class="fa fa-fw fa-check-double opacity-50 me-1 d-none d-sm-inline-block"></i> Complete Application
                                <?php if($mycourse != null && $mycourse->applicationApproval != null && count($education) > 0): ?>
                    ...
                    <div class="tab-content col-md-9">
                        <div class="block-content tab-pane <?php if($mycourse == null): ?> active <?php endif; ?> " id="btabs-vertical-require" role="tabpanel" aria-labelledby="btabs-vertical-work-tab">
                            <h4 class="fw-semibold"> Course Requirements </h4>
                            <h4 class="fs-sm fw-semibold">Minimum Course Requirements</h4>

                            <p class="text-amethyst-darker"><?php echo e($course->course_requirements); ?> </p>

                            <h4 class="fs-sm fw-semibold"> Minmimum Subject Requirements</h4>
                            <span class="h4 fs-sm">Subject 1</span> - <span class="ml-4"><?php echo e($course->subject1); ?></span> <br>
                            <span class="h4 fs-sm">Subject 2</span> - <span class="ml-4"><?php echo e($course->subject2); ?></span> <br>
                            <span class="h4 fs-sm">Subject 3</span> - <span class="ml-4"><?php echo e($course->subject3); ?></span> <br>
                            <span class="h4 fs-sm">Subject 4</span> - <span class="ml-4"><?php echo e($course->subject4); ?></span>
                        ...
                        <div class="block-content tab-pane" id="btabs-vertical-course" role="tabpanel" aria-labelledby="btabs-vertical-home-course">
                            ...
                            <div class="row my-1">
                                ...
                                <div class="col-sm-10 text-uppercase py-1">
                                    <input type="text" class="form-control form-control-md" name="course" value="<?php echo e($course->course_name); ?>" readonly>
                                </div>
                            </div>
                            <div class="row my-1">
                                <label class="col-sm-2 col-form-label" for="example-hf-email">Department</label>
                                <div class="col-sm-10 text-uppercase py-1">
                                    <input type="text" class="form-control form-control-md" name="department" value="<?php echo e($course->OnofferCourse->getCourseDept->name); ?>" readonly>
                                    <input type="hidden" name="school" value="<?php echo e($course->OnofferCourse->getCourseDept->schools->first()->school_id); ?>">
                                </div>
                            </div>
                            <div class="row my-1">
                                <label class="col-sm-2 col-form-label" for="example-hf-email">School</label>
                                <div class="col-sm-10 text-uppercase py-1">
                                    <input type="text" class="form-control form-control-md" name="" value="<?php echo e($course->OnofferCourse->getCourseDept->schools->first()->name); ?>" readonly>
                                    <input type="hidden" name="intake" value="<?php echo e($course->intake_id); ?>">
                            ...
                            <div class="row" style="padding: 5px !important;">
                                ...
                                <div class="col-sm-10 text-uppercase mb-4" style="padding: 5px !important;">
                                    <div class="space-x-0">
                                        <div class="form-check form-check-inline">
                                            <label class="form-check-label"><?php echo e($course->name); ?></label>
                                            <input class="form-check-input" type="radio" name="campus" value="<?php echo e($course->campus_id); ?>" checked readonly="readonly">
                                        </div>
                                ...
                                <div class="row mt-2 mb-4">
                                    ...
                                    <div class="col-md-8">
                                        <span class="h5 text-info"> <?php echo e($course->course_requirements); ?> </span>
                                     </div>
                                </div>
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-sm-10 text-uppercase py-1">
                                    <div class="form-floating input-group">
                                        <span class="input-group-text input-group-text-sm col-md-4"><?php echo e(Str::limit( $course->subject1, $limit = 15 , $end='' )); ?></span>
                                        ...
                                        <select class="form-control form-control-sm text-uppercase" name="subject1" <?php if($mycourse != null && $mycourse->declaration== 1): ?> disabled <?php endif; ?>>
                                            <option disabled selected> -- select subject-- </option>
                                                <?php if($mycourse != null): ?>
                                                    <option value="<?php if($mycourse != null): ?> <?php echo e(explode(' ', $subject->subject_1)[0]); ?> <?php endif; ?>" selected> <?php echo e(explode(' ', $subject->subject_1)[0]); ?></option>
                                                <?php endif; ?>
                                            <?php $__currentLoopData = explode('/', explode(' ', $course->subject1)[0]); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <span class="input-group-text input-group-text-sm">
                                            <select name="grade1" class="dept form-control form-control-md text-uppercase fs-sm" <?php if($mycourse != null && $mycourse->declaration == 1): ?> disabled <?php endif; ?>>
                                                <option selected disabled > -- select grade -- </option>
                                                    <?php if($mycourse != null): ?>
                                                        <option value=" <?php if($mycourse != null): ?> <?php echo e(explode(' ', $subject->subject_1)[1]); ?> <?php endif; ?>" selected> <?php echo e(explode(' ', $subject->subject_1)[1]); ?></option>
                                                    <?php endif; ?>
                            ...
                            <div class="row my-2">
                                ...
                                <div class="col-sm-10 text-uppercase py-1">
                                    <div class="form-floating input-group">
                                        <span class="input-group-text input-group-text-sm col-md-4"><?php echo e(Str::limit( $course->subject2, $limit = 15 , $end='' )); ?></span>
                                        <select class="form-control form-control-sm text-uppercase" name="subject2" <?php if($mycourse != null && $mycourse->declaration== 1): ?> disabled <?php endif; ?>>
                                            <option disabled selected> -- select subject-- </option>
                                                <?php if($mycourse != null): ?>
                                                    <option value=" <?php if($mycourse != null): ?> <?php echo e(explode(' ', $subject->subject_2)[0]); ?> <?php endif; ?>" selected> <?php echo e(explode(' ', $subject->subject_2)[0]); ?></option>
                                                <?php endif; ?>
                                            <?php $__currentLoopData = explode('/', explode(' ', $course->subject2)[0]); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($option); ?>"> <?php echo e($option); ?> </option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <span class="input-group-text input-group-text-sm">
                                            <select name="grade2" class="dept form-control form-control-md text-uppercase m-1 fs-sm" <?php if($mycourse != null && $mycourse->declaration== 1): ?> disabled <?php endif; ?>>
                                                <option selected disabled > -- select grade -- </option>
                                                    <?php if($mycourse != null): ?>
                                                        <option value=" <?php if($mycourse != null): ?> <?php echo e(explode(' ', $subject->subject_2)[1]); ?> <?php endif; ?>" selected> <?php echo e(explode(' ', $subject->subject_2)[1]); ?></option>
                                                    <?php endif; ?>
                                                <option value="A"> A </option>
                                                <option value="A-"> A- </option>
                                                <option value="B+"> B+ </option>
                            ...
                            <div class="row my-2">
                                ...
                                <div class="form-floating col-sm-10 text-uppercase py-1">
                                    <div class="form-floating input-group">
                                        <span class="input-group-text input-group-text-sm col-md-4"><?php echo e(Str::limit( $course->subject3, $limit = 15 , $end='' )); ?></span>
                                        ...
                                        <select class="form-control form-control-sm text-uppercase" name="subject3" <?php if($mycourse != null && $mycourse->declaration== 1): ?> disabled <?php endif; ?>>
                                            <option disabled selected> -- select subject-- </option>
                                                <?php if($mycourse != null): ?>
                                                    <option value=" <?php if($mycourse != null): ?> <?php echo e(explode(' ', $subject->subject_3)[0]); ?> <?php endif; ?>" selected> <?php echo e(explode(' ', $subject->subject_3)[0]); ?></option>
                                                <?php endif; ?>
                                            <?php $__currentLoopData = explode('/', explode(' ', $course->subject3)[0]); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($option); ?>"> <?php echo e($option); ?> </option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <span class="input-group-text input-group-text-sm">
                                            <select name="grade3" class="dept form-control form-control-md text-uppercase m-1 fs-sm" <?php if($mycourse != null && $mycourse->declaration== 1): ?> disabled <?php endif; ?>>
                                                <option selected disabled > -- select grade -- </option>
                                                    <?php if($mycourse != null): ?>
                                                        <option value=" <?php if($mycourse != null): ?> <?php echo e(explode(' ', $subject->subject_3)[1]); ?> <?php endif; ?>" selected> <?php echo e(explode(' ', $subject->subject_3)[1]); ?></option>
                                                    <?php endif; ?>
                                                <option value="A"> A </option>
                                                <option value="A-"> A- </option>
                                                <option value="B+"> B+ </option>
                            ...
                            <div class="row my-2">
                                ...
                                <div class="col-sm-10 text-uppercase py-1">
                                    <div class="form-floating input-group">
                                        <span class="input-group-text input-group-text-sm col-md-4"><?php echo e(Str::limit( $course->subject4, $limit = 15 , $end='' )); ?></span>
                                        ...
                                        <select class="form-control form-control-sm text-uppercase" name="subject4" <?php if($mycourse != null && $mycourse->declaration== 1): ?> disabled <?php endif; ?>>
                                            <option disabled selected> -- select subject-- </option>
                                                <?php if($mycourse != null): ?>
                                                    <option value=" <?php if($mycourse != null): ?> <?php echo e(explode(' ', $subject->subject_4)[0]); ?> <?php endif; ?>" selected><?php echo e(explode(' ', $subject->subject_4)[0]); ?></option>
                                                <?php endif; ?>
                                            <?php $__currentLoopData = explode('/', explode(' ', $course->subject4)[0]); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($option); ?>"> <?php echo e($option); ?> </option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <span class="input-group-text input-group-text-sm">
                                            <select name="grade4" class="dept form-control form-control-md text-uppercase m-1 fs-sm" <?php if($mycourse != null && $mycourse->declaration== 1): ?> disabled <?php endif; ?>>
                                                <option selected disabled > -- select grade -- </option>
                                                    <?php if($mycourse != null): ?>
                                                        <option value=" <?php if($mycourse != null): ?> <?php echo e(explode(' ', $subject->subject_4)[1]); ?> <?php endif; ?>" selected> <?php echo e(explode(' ', $subject->subject_4)[1]); ?></option>
                                                    <?php endif; ?>
                                                <option value="A"> A </option>
                                                <option value="A-"> A- </option>
                                                <option value="B+"> B+ </option>
                        ...
                        <div class="block-content tab-pane <?php if(count($education) <= 0 && $mycourse != null): ?> active <?php endif; ?> " id="btabs-vertical-education" role="tabpanel" aria-labelledby="btabs-vertical-education-tab">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $education; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($row->start_date); ?></td>
                                            <td><?php echo e($row->exit_date); ?></td>
                                            <td><button type="button" class="btn btn-sm btn-alt-info" data-bs-toggle="modal" data-bs-target="#modal-block-vcenter-<?php echo e($row->id); ?>">edit</button>

                                                <div class="modal" id="modal-block-vcenter-<?php echo e($row->id); ?>" tabindex="-1" role="dialog" aria-labelledby="modal-block-vcenter" aria-hidden="true">
                                                            ...
                                                            <div class="block block-rounded block-transparent mb-0">
                                                                ...
                                                                <div class="block-content fs-sm">
                                                                    <?php if($row->level == 'SECONDARY'): ?>
                                                                        <form method="POST" action="<?php echo e(route('application.updateSecSch', Crypt::encrypt($row->id))); ?>" enctype="multipart/form-data">
                                                                            <?php echo csrf_field(); ?>
                                                                            <div class="row my-1">
                                                                                <div class="col-md-12">
                                                                                    <div class="form-floating col-sm-12 py-1">
                                                                                        <input type="text" class="form-control form-control-sm text-uppercase" value="<?php echo e($row->institution); ?>" name="secondary" placeholder="Institution name">
                                                                                        <label class="form-label">SCHOOL NAME</label>
                                                                                    </div>
                                                                                    <div class="form-floating col-sm-12 py-1">
                                                                                        <input type="text" class="form-control form-control-sm text-uppercase" value="<?php echo e($row->qualification); ?>" name="secondaryqualification" placeholder="Qualifications acquired">
                                                                                        <label class="form-label">QUALIFICATION</label>
                                                                                    </div>
                                                                                    <input type="hidden" value="SECONDARY" name="level">
                                                                                    <div class="row">
                                                                                        <div class="form-floating col-6">
                                                                                            <input type="month" class="form-control form-control-sm" value="<?php echo e($row->start_date); ?>" name="secstartdate">
                                                                                            <small class="text-muted">Starting year</small>
                                                                                        </div>
                                                                                        <div class="form-floating col-6">
                                                                                            <input type="month" class="form-control form-control-sm" value="<?php echo e($row->exit_date); ?>" name="secenddate">
                                                                                            <small class="text-muted">Year Finished</small>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="form-floating col-sm-12 py-1">
                                                                    ...
                                                                    <?php else: ?>
                                                                        <form action="<?php echo e(route('application.updateTerSch', Crypt::encrypt($row->id))); ?>" method="POST" enctype="multipart/form-data">
                                                                            <?php echo csrf_field(); ?>
                                                                            <div class="row my-1">
                                                                                <div class="col-md-12">
                                                                                    <div class="form-floating col-sm-12 py-1">
                                                                                        <input type="text" class="form-control form-control-sm text-uppercase py-2" value="<?php echo e($row->institution); ?>" name="tertiary" placeholder="INSTITUTION NAME">
                                                                                        <label class="form-label">INSTITUTION NAME</label>
                                                                                    </div>

                                                                                    <div class="form-floating col-sm-12 py-1">
                                                                                        <select name="level" class="form-control form-control-sm">
                                                                                            <option selected disabled value="<?php echo e($row->level); ?>"> <?php echo e($row->level); ?></option>
                                                                                    ...
                                                                                    <div class="form-floating col-sm-12 py-1">
                                                                                        <input type="text" class="form-control form-control-sm text-uppercase" value="<?php echo e($row->qualification); ?>" name="teriaryqualification" placeholder="Qualifications acquired">
                                                                                        <label class="form-label">QUALIFICATION</label>
                                                                                    </div>

                                                                                    <div class="row py-1">
                                                                                        <div class="form-floating col-sm-6">
                                                                                            <input type="month" class="form-control form-control-sm" value="<?php echo e($row->start_date); ?>" name="terstartdate">
                                                                                            <small class="text-muted py-1">Starting year</small>
                                                                                        </div>
                                                                                        <div class="form-floating col-sm-6">
                                                                                            <input type="month" class="form-control form-control-sm" value="<?php echo e($row->exit_date); ?>" name="terenddate">
                        ...
                        <div class="block-content tab-pane <?php if($mycourse != null && $mycourse->receipt == null && count($education) >= 1 && $mycourse->declaration == 1): ?> active <?php endif; ?>" id="btabs-vertical-fee" role="tabpanel" aria-labelledby="btabs-vertical-fee-tab">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <p> You are required to pay <span class="fw-bold"> Ksh. <?php echo e($course->application_fee); ?> </span> to complete this application.</p>
                                    <?php if($mycourse != null): ?>
                                    <p>To complete application payment use <b><?php echo e($mycourse->application_number); ?></b> as account number for any of the preferred payment method</p>
                                    <?php else: ?>
                                    <?php endif; ?>
                        ...
                        <div class="block-content tab-pane <?php if($mycourse != null && $mycourse->applicationApproval == null && count($education) > 0): ?> active <?php endif; ?> " id="btabs-vertical-submit" role="tabpanel" aria-labelledby="btabs-vertical-submit-tab">
                            <h4 class="fw-semibold">Finish application</h4>
                            <p class="fs-sm">
                            <div class="block-content-full">
                                    <div class="p-sm-2 p-xl-12">
                                        <div class="row mb-2 text-center">
                                            <span class="fw-semibold mb-2"> <?php echo e($course->OnofferCourse->getCourseDept->schools->first()->name); ?> </span>
                                            <span class="fw-semibold mb-2"> <?php echo e($course->OnofferCourse->getCourseDept->name); ?> </span>
                                            <span class="fw-semibold mb-2"> <?php echo e($course->course_name); ?> </span>
                                        </div>
                                        ...
                                        <table class="table table-sm table-bordered table-striped table-responsive-md">
                                            <?php if($mycourse != null): ?>
                                                ...
                                                <tr>
                                                    <td>
                                                        <?php if($mycourse->applicationApproval != null): ?>
                                                        <?php echo e($mycourse->applicationApproval->invoice_number); ?>
                                                    ...
                                                    <td>
                                                        <?php if($mycourse->applicationApproval != null && $mycourse->applicationApproval->finance_status == 1): ?>
                                            ...
                                            <?php endif; ?>
                                                <?php if($mycourse != null): ?>
                                                    <thead>
                                                        ...
                                                        <th colspan="2"> <?php echo e($course->course_requirements); ?> </th>
                                                    </thead>

                                                    <thead>
                                                    <th colspan="1">Application Reference Number</th>
                                                    <th colspan="2"> <?php echo e($mycourse->ref_number); ?> </th>
                                                    </thead>
                                                <?php endif; ?>
                                            <?php if($mycourse != null): ?>
                                                        <thead>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td><?php echo e($course->subject1); ?></td>
                                                            <td><?php echo e($subject->subject_1); ?></td>
                                                            <td>
                                                                <?php
                                                        ...
                                                        <tr>
                                                            <td><?php echo e($course->subject2); ?></td>
                                                            <td><?php echo e($subject->subject_2); ?></td>
                                                            <td>
                                                                <?php
                                                        ...
                                                        <tr>
                                                            <td><?php echo e($course->subject3); ?></td>
                                                            <td><?php echo e($subject->subject_3); ?></td>
                                                            <td>
                                                                <?php
                                                        ...
                                                        <tr>
                                                            <td><?php echo e($course->subject4); ?></td>
                                                            <td><?php echo e($subject->subject_4); ?></td>
                                                            <td>
                                                                <?php
                                                    ...
                                                    <tr>
                                                        <td colspan="3">
                                                            <?php if($score1 >= $grade1 && $score2 >= $grade2 && $score3 >= $grade3 && $score4 >= $grade4): ?>
                                                                <p class="text-success text-center fs-sm m-2">
                                                                    Congratulations!! You meet the minimum course subject requirements to pursue <?php echo e($course->course_name); ?> Course. Please proceed to submit your application for approval.
                                                                </p>
                                                            <?php else: ?>
                                                                <p class="text-warning text-center fs-sm m-2">
                                                                    Oops! You do not meet the minimum course subject requirements to pursue <?php echo e($course->course_name); ?> Course. Please try looking for a course that you meet the minimum course subject requirements. Submiting this application will not guarantee you selection.
                                                                </p>
                                                            <?php endif; ?>
                                                        </td>
                                                    </tr>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="" style="padding: 7px !important;">
                                        ...
                                        <input hidden name="course_id" value="<?php if($mycourse != null): ?> <?php echo e($mycourse->course_id); ?> <?php endif; ?>">
                                        <input hidden name="intake_id" value="<?php if($mycourse != null): ?> <?php echo e($mycourse->intake_id); ?> <?php endif; ?>">
                                        I <span class="text-decoration-underline"> <?php echo e(auth()->guard('web')->user()->infoApplicant->surname); ?> <?php echo e(auth()->guard('web')->user()->infoApplicant->middle_name); ?> <?php echo e(auth()->guard('web')->user()->infoApplicant->first_name); ?></span> declare that the information given in this application form is correct. I further certify that I have read, understood and agreed to comply with the terms stipulated herein.
                                    </div>
                                </div>
...
<?php echo $__env->make('application::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\smis\application\Modules/Application\Resources/views/applicant/application.blade.php ENDPATH**/ ?>