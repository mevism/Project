            ...
            <div class="col-sm-12">
                ...
                <div class="block block-rounded row g-0">
                    <ul class="nav nav-tabs nav-tabs-block flex-md-column col-md-3" role="tablist">
                        ...
                        <li class="nav-item d-md-flex flex-md-column">
                            <button class="nav-link text-md-start <?php if($mycourse != null && $mycourse->receipt == null && count($education) >= 1): ?> active <?php endif; ?> " id="btabs-vertical-fee-tab" data-bs-toggle="tab" data-bs-target="#btabs-vertical-fee" role="tab" aria-controls="btabs-vertical-fee" aria-selected="false">
                        ...
                        <li class="nav-item d-md-flex flex-md-column">
                            <button class="nav-link text-md-start <?php if($mycourse != null && $mycourse->receipt != null && count($education) > 0): ?> active <?php endif; ?> " id="btabs-vertical-submit-tab" data-bs-toggle="tab" data-bs-target="#btabs-vertical-submit" role="tab" aria-controls="btabs-vertical-submit" aria-selected="false">
                    ...
                    <div class="tab-content col-md-9">
                                    ...
                                    <div class="form-floating input-group">
                                        ...
                                        <select class="form-control form-control-sm text-uppercase" name="subject1" <?php if($mycourse != null && $mycourse->declaration== 1): ?> disabled <?php endif; ?>>
                                            <option disabled selected> -- select subject-- </option>
                                                ...
                                                <?php endif; ?>
                                            <?php $__currentLoopData = explode('/', explode(' ', $course->mainCourses->courseRequirements->subject1)[0]); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="form-floating input-group">
                                        ...
                                        <select class="form-control form-control-sm text-uppercase" name="subject2" <?php if($mycourse != null && $mycourse->declaration== 1): ?> disabled <?php endif; ?>>
                                            <option disabled selected> -- select subject-- </option>
                                                ...
                                                <?php endif; ?>
                                            <?php $__currentLoopData = explode('/', explode(' ', $course->mainCourses->courseRequirements->subject2)[0]); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($option); ?>"> <?php echo e($option); ?> </option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="form-floating input-group">
                                        ...
                                        <select class="form-control form-control-sm text-uppercase" name="subject3" <?php if($mycourse != null && $mycourse->declaration== 1): ?> disabled <?php endif; ?>>
                                            <option disabled selected> -- select subject-- </option>
                                                ...
                                                <?php endif; ?>
                                            <?php $__currentLoopData = explode('/', explode(' ', $course->mainCourses->courseRequirements->subject3)[0]); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($option); ?>"> <?php echo e($option); ?> </option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="form-floating input-group">
                                        ...
                                        <select class="form-control form-control-sm text-uppercase" name="subject4" <?php if($mycourse != null && $mycourse->declaration== 1): ?> disabled <?php endif; ?>>
                                            <option disabled selected> -- select subject-- </option>
                                                ...
                                                <?php endif; ?>
                                            <?php $__currentLoopData = explode('/', explode(' ', $course->mainCourses->courseRequirements->subject4)[0]); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($option); ?>"> <?php echo e($option); ?> </option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="block-content tab-pane <?php if($mycourse != null && $mycourse->receipt == null && count($education) >= 1): ?> active <?php endif; ?>" id="btabs-vertical-fee" role="tabpanel" aria-labelledby="btabs-vertical-fee-tab">
                        ...
                        <div class="block-content tab-pane <?php if($mycourse != null && $mycourse->receipt != null && count($education) > 0): ?> active <?php endif; ?> " id="btabs-vertical-submit" role="tabpanel" aria-labelledby="btabs-vertical-submit-tab">
                                            ...
                                            <?php if($mycourse != null): ?>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td><?php echo e($mycourse->subject_1); ?></td>
                                                            <td>
                                                                <?php
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo e($mycourse->subject_2); ?></td>
                                                            <td>
                                                                <?php
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo e($mycourse->subject_3); ?></td>
                                                            <td>
                                                                <?php
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo e($mycourse->subject_4); ?></td>
                                                            <td>
                                                                <?php
                                                        ...
                                                        <td colspan="3">
                                                            <?php if($score1 >= $grade1 && $score2 >= $grade2 && $score3 >= $grade3 && $score4 >= $grade4): ?>
                                                                <p class="text-success text-center fs-sm m-2">
                                                                    Congratulations!! You meet the minimum course subject requirements to pursue <?php echo e($course->mainCourses->course_name); ?> Course. Please proceed to submit your application for approval.
                                                                </p>
                                                            <?php else: ?>
                                                                <p class="text-warning text-center fs-sm m-2">
                                                                    Oops! You do not meet the minimum course subject requirements to pursue <?php echo e($course->mainCourses->course_name); ?> Course. Please try looking for a course that you meet the minimum course subject requirements. Submiting this application will not guarantee you selection.
                                                                </p>
                                                            <?php endif; ?>
                                                        </td>
                                                    </tr>
