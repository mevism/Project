    ...
    <div class="content">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 space-y-1">
                        <div class="content-boxed block-content-full">
                            <iframe src="<?php echo e(url('receipts/', $app->receipt_file)); ?>" type="application/pdf" style="width: 100% !important; height: 80vh !important;"> </iframe>
                        </div>
                    </div>
                </div>
            </div>
        <div class="d-flex justify-content-center py-1">
            <?php if($app->finance_status== 0): ?>
                <a class="btn btn-sm btn-alt-success m-2" data-toggle="click-ripple" href="<?php echo e(route('finance.acceptApplication', ['id' => Crypt::encrypt($app->id)])); ?>">Accept</a>
            ...
            <div class="modal-content">
                <div class="block block-rounded block-transparent mb-0">
                    ...
                    <div class="block-content fs-sm">
                        <form action="<?php echo e(route('finance.rejectApplication', ['id' => Crypt::encrypt($app->id)])); ?>" method="post">
                            <?php echo csrf_field(); ?>
    ...
    <div class="modal fade" id="modal-block-popin1" tabindex="-1" role="dialog" aria-labelledby="modal-block-popin" aria-hidden="true">
        <div class="modal-dialog modal-dialog-popin" role="document">
            <div class="modal-content">
                <div class="block block-rounded block-transparent mb-0">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">Reason(s) for reverting <?php echo e($app->applicant->mname); ?>'s application </h3>
                        <div class="block-options">
                            <button type="button" class="btn-block-option" data-bs-dismiss="modal" aria-label="Close">
                                <i class="fa fa-fw fa-times"></i>
                            </button>
                    ...
                    <div class="block-content block-content-full fs-sm">
                        <form action="<?php echo e(route('finance.revertApplication', ['id' => Crypt::encrypt($app->id)])); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            <div class="d-flex justify-content-center">
...
<?php echo $__env->make('applications::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\smis\application\Modules/Finance\Resources/views/applications/viewApplication.blade.php ENDPATH**/ ?>