                        ...
                        <?php if(count($apps)>0): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php elseif($app->finance_status == 4): ?>
                                ...
                                <td>
                                <?php if($app->finance_status == 0): ?>
                                <a class="btn btn-sm btn-alt-secondary" href="<?php echo e(route('finance.viewApplication', ['id' => Crypt::encrypt($app->id)])); ?>"> View </a>
                                        <?php else: ?>
                                    <div class="d-flex justify-content-between">
                                <a class="btn btn-sm btn-alt-secondary" href="<?php echo e(route('finance.previewApplication', ['id' => Crypt::encrypt($app->id)])); ?>"> View </a>
                                <a class="btn btn-sm btn-alt-info" href="<?php echo e(route('finance.viewApplication', ['id' => Crypt::encrypt($app->id)])); ?>"> Edit </a>
                                    </div>
                                <?php endif; ?>
                                </td>
                            </tr>
...
<?php echo $__env->make('applications::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Registrar/application/Modules/Finance/Resources/views/applications/index.blade.php ENDPATH**/ ?>