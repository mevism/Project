          ...
          <ul class="nav-main">
            <li class="nav-main-item">
              <a class="nav-main-link<?php echo e(request()->is('dashboard') ? ' active' : ''); ?>" href="<?php echo e(route('dashboard')); ?>">
                ...
                <span class="nav-main-link-name">
                    <?php if(auth()->guard('user')->user()->role_id == 7): ?>
                        Examination
                    <?php endif; ?>
                </span>
            ...
            <li class="nav-main-item<?php echo e(request()->is('intakes/*') ? ' open' : ''); ?>">
              ...
              <ul class="nav-main-submenu">
                    <li class="nav-main-item">
                          <a class="nav-main-link<?php echo e(request()->is('school/showSchool') ? ' active' : ''); ?>" href="<?php echo e(route('examination.registration')); ?>">
                            <i class="nav-main-link-icon si si-graduation"></i>
...
<?php /**PATH /var/www/html/Registrar/application/Modules/Examination/Resources/views/layouts/backend.blade.php ENDPATH**/ ?>