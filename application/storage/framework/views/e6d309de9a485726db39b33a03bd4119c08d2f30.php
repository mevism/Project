        ...
        <div class="content-side">
          <ul class="nav-main">
            <li class="nav-main-item">
              <a class="nav-main-link<?php echo e(request()->is('dashboard') ? ' active' : ''); ?>" href="<?php echo e(route('dashboard')); ?>">
                ...
                <span class="nav-main-link-name">
                   <?php if(auth()->guard('user')->user()->hasRole('Lecturer')): ?>
                        Lecturer
                    <?php endif; ?>
                </span>
              ...
              <li class="nav-main-item<?php echo e(request()->is('intakes/*') ? ' open' : ''); ?>">
                  ...
                  <ul class="nav-main-submenu">
                     <li class="nav-main-item">
                          <a class="nav-main-link<?php echo e(request()->is('courses/showCourse') ? ' active' : ''); ?>" href="<?php echo e(route('lecturer.viewWorkload')); ?>">
            ...
            <li class="nav-main-item<?php echo e(request()->is('intakes/*') ? ' open' : ''); ?>">
              ...
              <ul class="nav-main-submenu">
                  <li class="nav-main-item">
                      <a class="nav-main-link<?php echo e(request()->is('intake/showIntake') ? ' active' : ''); ?>" href="<?php echo e(route('lecturer.examination')); ?>">
              ...
              <li class="nav-main-item<?php echo e(request()->is('intakes/*') ? ' open' : ''); ?>">
                  ...
                  <ul class="nav-main-submenu">
                      <li class="nav-main-item">
                          <a class="nav-main-link<?php echo e(request()->is('intake/showIntake') ? ' active' : ''); ?>" href="<?php echo e(route ('lecturer.myProfile')); ?>">
                              <i class="nav-main-link-icon si si-calendar"></i>
                  ...
                  <ul class="nav-main-submenu">
                      <li class="nav-main-item">
                          <a class="nav-main-link<?php echo e(request()->is('intake/showIntake') ? ' active' : ''); ?>" href="<?php echo e(route('lecturer.qualifications')); ?>">
                              <i class="nav-main-link-icon si si-calendar"></i>
                  ...
                  <ul class="nav-main-submenu">
                      <li class="nav-main-item">
                          <a class="nav-main-link<?php echo e(request()->is('intake/showIntake') ? ' active' : ''); ?>" href="<?php echo e(route('lecturer.teachingAreas')); ?>">
                              <i class="nav-main-link-icon si si-calendar"></i>
...
<?php /**PATH C:\xampp\htdocs\project1\application\Modules/Lecturer\Resources/views/layouts/backend.blade.php ENDPATH**/ ?>