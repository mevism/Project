                            ...
                            <div class="w-100">
                                ...
                                <div class="text-center mb-5">
                                    <h5 class="fw-bold mb-2 text-uppercase">
                                        Phone Verification | <?php echo e(auth()->guard('epayments')->user()->phone_number); ?>
                                ...
                                <div class="row g-0 justify-content-center">
                                    <div class="col-sm-8 col-xl-4">
                                        <form class="js-validation-signin" action="<?php echo e(route('payment.verification')); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
                                            <div class="form-floating mb-4">
                                                <input type="hidden" class="form-control form-control-alt" name="phone_number" value="<?php echo e(auth()->guard('epayments')->user()->phone_number); ?>" >
                                            </div>
                                            <div class="form-floating mb-4">
                                            ...
                                            <div class="d-flex justify-content-center">
                                                <a class="link link-primary" href="<?php echo e(route('payment.getNewCode')); ?>" data-toggle="click-ripple">Get new code</a>
                                            </div>
                                        </form>
                                    </div>
                                </div>
...
<?php echo $__env->make('epayment::layouts.simple', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\smis\application\Modules/Epayment\Resources/views/verifyPhone.blade.php ENDPATH**/ ?>