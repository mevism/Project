            ...
            <div class="content-side">
                <ul class="nav-main">
                    <li class="nav-main-item">
                        <a class="nav-main-link<?php echo e(request()->is('dashboard') ? ' active' : ''); ?>" href="<?php echo e(route('epayment.student')); ?>">
                            <i class="nav-main-link-icon fas fa-house-user"></i>
                    ...
                    <li class="nav-main-item<?php echo e(request()->is('pages/*') ? ' open' : ''); ?>">
                        ...
                        <ul class="nav-main-submenu">
                            <li class="nav-main-item">
                                <a class="nav-main-link<?php echo e(request()->is('pages/datatables') ? ' active' : ''); ?>" href="<?php echo e(route('epayment.requestPay')); ?>">
                                    <span class="nav-main-link-name">Request Payment</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-main-item<?php echo e(request()->is('pages/*') ? ' open' : ''); ?>">
                        <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="true" href="#">
                            <i class="nav-main-link-icon fas fa-list-squares"></i>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown d-inline-block ms-2">
                    <button type="button" class="btn btn-sm btn-alt-dark d-flex align-items-center" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <span class="d-none d-sm-inline-block ms-2"> <?php echo e(auth()->guard('epayments')->user()->student_name); ?> </span>
                    ...
                    <div class="dropdown-menu dropdown-menu-md dropdown-menu-end p-0 border-0" aria-labelledby="page-header-user-dropdown">
                        <div class="p-3 text-center bg-body-light border-bottom rounded-top">
                            ...
                            <p class="mt-2 mb-0 fw-medium"><?php echo e(auth()->guard('epayments')->user()->student_name); ?></p>
...
<?php /**PATH C:\xampp\htdocs\smis\application\Modules/Epayment\Resources/views/layouts/backend.blade.php ENDPATH**/ ?>