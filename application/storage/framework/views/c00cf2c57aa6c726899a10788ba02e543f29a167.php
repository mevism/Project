    ...
    <div class="content">
        <div class="block block-rounded">
            <div class="block-content block-content-full">
                <div class="row">
                    <div class="col-lg-5 mb-1 fs-sm">
                        ...
                        <?php if($data->dean_status == 2): ?>

                            <div class="row p-1">
                                <div class="col-md-4 fw-bolder text-start">Why rejected?</div>
                                <div class="col-md-8">
                                    <p><?php echo e($data->dean_remarks); ?></p>
                                </div>
                            </div>
            ...
            <div class="d-flex justify-content-center py-1">
              <a class="btn btn-sm btn-alt-secondary m-2" data-toggle="click-ripple" href="<?php echo e(route('dean.transfer')); ?>">Close</a>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                <div class="block block-rounded block-transparent mb-0">
                    ...
                    <div class="block-content fs-sm">
                        <form action="<?php echo e(route('dean.rejectTransfer',[ 'id' => Crypt::encrypt($data->id)])); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            <div class="row col-md-12 mb-3">
                                ...
                                <input type="hidden" name="<?php echo e($data->id); ?>">
                            </div>
...
<?php echo $__env->make('dean::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Registrar/application/Modules/Dean/Resources/views/transfers/preview.blade.php ENDPATH**/ ?>