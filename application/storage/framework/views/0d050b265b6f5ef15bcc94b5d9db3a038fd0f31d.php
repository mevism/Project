                ...
                <table id="example"  class="table table-sm table-striped table-bordered fs-sm">
                    ...
                    <?php $__currentLoopData = $leaves; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $leave): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-sm btn-outline-dark" href="<?php echo e(route('department.viewLeaveRequest', ['id' => Crypt::encrypt($leave->id)])); ?>"> View </a>
...
<?php echo $__env->make('cod::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Registrar/application/Modules/COD/Resources/views/leaves/annualLeaves.blade.php ENDPATH**/ ?>