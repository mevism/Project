            ...
            <div class="block-content block-content-full">
                <div class="row">
                    <div class="col-lg-6 mb-0 fs-sm">
                        ...
                        <div class="col-md-8"> <?php echo e($app->appApproval->applicant->sname); ?> <?php echo e($app->appApproval->applicant->fname); ?> <?php echo e($app->appApproval->applicant->mname); ?></div>
                        </div>
                        <div class="row p-1">
                            <div class="col-md-4 fw-bolder text-start">Course Name</div>
                            <div class="col-md-8"> <?php echo e($app->appApproval->courses->course_name); ?> </div>
                        </div>
                        <div class="row p-1">
                            <div class="col-md-4 fw-bolder text-start">Transaction Code</div>
                            <div class="col-md-8"> <?php echo e($app->appApproval->receipt); ?> </div>
                        </div>
                    </div>
                    <div class="col-lg-6 space-y-1">
                        <div class="d-flex justify-content-center">
                            <div class="card-img" style="margin: auto !important;">
                                <img style="margin: auto !important; max-height: 80vh !important; width: 100% !important;" src="<?php echo e(url('receipts/', $app->appApproval->receipt_file)); ?>" alt="">
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('applications::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sims\application\Modules/Finance\Resources/views/admissions/review.blade.php ENDPATH**/ ?>