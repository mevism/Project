        ...
        <div class="content-side">
          <ul class="nav-main">
            ...
            <li class="nav-main-item<?php echo e(request()->is('pages/*') ? ' open' : ''); ?>">
              ...
              <?php if(Auth::guard('student')->user()->loggedStudent->courseStudent->student_type == 2): ?>
                    <ul class="nav-main-submenu">
                        <li class="nav-main-item">
...
<?php /**PATH C:\xampp\htdocs\project\application\Modules/Student\Resources/views/layouts/backend.blade.php ENDPATH**/ ?>