    ...
    <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-6 mb-0 fs-sm">
                        ...
                        <div class="row p-1">
                            ...
                            <div class="col-md-8"> <?php echo e($app->appApprovals->receipt); ?> </div>
                        </div>
                    </div>
                    <div class="col-lg-6 space-y-1">
                        <div class="d-flex justify-content-center">
                            <div class="card-img" style="margin: auto !important;">
                                <img style="margin: auto !important; max-height: 80vh !important; width: 100% !important;" src="<?php echo e(url('receipts/', $app->appApprovals->receipt_file)); ?>" alt="">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="d-flex justify-content-center py-1">
            <?php if($app->finance_status === 0): ?>
                <a class="btn btn-sm btn-alt-success m-2" data-toggle="click-ripple" href="<?php echo e(route('finance.acceptAdmission', $app->id)); ?>">Approve</a>
...
<?php echo $__env->make('applications::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Sims/application/Modules/Finance/Resources/views/admissions/review.blade.php ENDPATH**/ ?>