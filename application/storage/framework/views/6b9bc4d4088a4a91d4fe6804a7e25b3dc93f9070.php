                    ...
                    <table id="example" class="table table-responsive table-md table-striped table-bordered table-vcenter fs-sm">
                        <?php if(count($apps)>0): ?>
                            ...
                            <tr>
                                ...
                                <td> <?php echo e($app->courses->department_id); ?></td>
                                ...
                                <td nowrap="">
                                    <?php if($app->cod_status === 0): ?>
                                <a class="btn btn-sm btn-alt-secondary" href="<?php echo e(route('cod.viewApplication', $app->id)); ?>"> View </a>
                                        <?php else: ?>
                                <a class="btn btn-sm btn-alt-secondary" href="<?php echo e(route('cod.previewApplication', $app->id)); ?>"> View </a>
...
<?php echo $__env->make('cod::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xamp\htdocs\courses\project\application\Modules/COD\Resources/views/applications/index.blade.php ENDPATH**/ ?>