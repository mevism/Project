                            ...
                            <div class="w-100">
                                ...
                                <div class="text-center mb-5">
                                    <h5 class="fw-bold mb-2 text-uppercase">
                                        Phone Verification | <?php echo e(Auth::user()->mobile); ?>
                                    ...
                                    <div class="col-sm-8 col-xl-4">
                                        <form class="js-validation-signin" action="<?php echo e(route('application.phonereverification')); ?>" method="POST">
                                            ...
                                            <div class="form-floating mb-4">
                                                <input type="hidden" class="form-control form-control-alt" name="phone_number" value="<?php echo e(Auth::user()->mobile); ?>">
                                            </div>
                                            <div class="form-floating mb-4">
