                ...
                <div class="col-lg-12">
                    <table id="example" class="table table-responsive table-md table-striped table-bordered table-vcenter fs-sm">
                        ...
                        <?php $__currentLoopData = $admission; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $app): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($app->appApproval->applicant->sname); ?> <?php echo e($app->appApproval->applicant->mname); ?> <?php echo e($app->appApproval->applicant->fname); ?></td>
                                <td><?php echo e($app->appApproval->courses->department_id); ?></td>
                                <td><?php echo e($app->appApproval->courses->course_name); ?></td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <?php if($app->medical_status === 0): ?>
                                        <a class="btn btn-sm btn-alt-success" data-toogle="click-ripple" onclick="return confirm('Are you sure you want to approve?')" href="<?php echo e(route('medical.acceptAdmission', $app->id)); ?>"> approve</a>
                                    ...
                                    <?php elseif($app->medical_status === 1): ?>
                                        ...
                                        <a class="btn btn-sm btn-alt-success" data-toogle="click-ripple" href="<?php echo e(route('medical.submitAdmission',$app->id)); ?>"> submit</a>
                                            <div class="modal fade" id="modal-block-popin" tabindex="-1" role="dialog" aria-labelledby="modal-block-popin<?php echo e($app->id); ?>" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-popin" role="document">
                                                    <div class="modal-content">
                                                        <div class="block block-rounded block-transparent mb-0">
...
<?php echo $__env->make('medical::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sims\application\Modules/Medical\Resources/views/admissions/index.blade.php ENDPATH**/ ?>