                        ...
                        <?php $__currentLoopData = $admission; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $app): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td nowrap="">
                                    ...
                                    <?php if($app->medical_status === 0): ?>
                                        <a class="btn btn-sm btn-alt-info" data-toogle="click-ripple" onclick="return confirm('Are you sure you want to approve?')" href="<?php echo e(route('medical.acceptAdmission', $app->id)); ?>"> Accept</a>
                                    ...
                                    <?php elseif($app->medical_status === 1): ?>
                                        <a class="btn btn-sm btn-alt-success" data-toogle="click-ripple" onclick="return confirm('Are you sure you want to submit this record?')" href="<?php echo e(route('medical.submitAdmission',$app->id)); ?>"> submit</a>
