...
<?php $__env->startSection('content'); ?>
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="col-6 col-md-3 col-lg-6 col-xl-3">
                <a class="block block-rounded block-link-pop border-start border-primary border-4" href="<?php echo e(route('cod.selfAdmissions')); ?>">
                    <div class="block-content block-content-full">
...
<?php echo $__env->make('cod::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xamp\htdocs\project\application\Modules/COD\Resources/views/COD/index.blade.php ENDPATH**/ ?>