...
<div class="block block-rounded">
    <div class="block-content block-content-full">
        <div class="d-flex justify-content-center">
            ...
            <form method="POST" action="<?php echo e(route('lecturer.storeQualifications')); ?>">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('lecturer::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\project1\application\Modules/Lecturer\Resources/views/profile/addqualifications.blade.php ENDPATH**/ ?>