                            ...
                            <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td nowrap="">
                                        ...
                                        <a class="btn btn-sm btn-alt-success" target="_top" href="<?php echo e(route('application.download', ['id' => Crypt::encrypt($course->id)])); ?>"><i class="fa fa-file-pdf"></i> download</a>
...
<?php echo $__env->make('application::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Registrar/application/Modules/Application/Resources/views/applicant/mycourses.blade.php ENDPATH**/ ?>