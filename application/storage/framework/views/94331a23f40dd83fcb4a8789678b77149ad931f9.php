                    ...
                    <table id="example" class="table table-responsive table-md table-striped table-bordered table-vcenter fs-sm">
                            ...
                            <?php $__currentLoopData = $applicant; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $app): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($app->appApproval->receipt); ?></td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <?php elseif($app->finance_status === 1): ?>
                                            ...
                                            <a class="btn btn-sm btn-alt-success" data-toogle="click-ripple" href="<?php echo e(route('finance.submitAdmission',$app->id)); ?>"> submit</a>
                                        <?php else: ?>
                                            <a class="btn btn-sm btn-alt-primary" data-toogle="click-ripple" href="<?php echo e(route('finance.reviewAdmission', $app->id)); ?>"> edit</a>
                                        <?php endif; ?>
                                    </td>
...
<?php echo $__env->make('applications::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xamp\htdocs\courses\project\application\Modules/Finance\Resources/views/admissions/index.blade.php ENDPATH**/ ?>