                    ...
                    <div class="tab-content col-md-9">
                        <div class="block-content tab-pane active" id="btabs-vertical-course" role="tabpanel" aria-labelledby="btabs-vertical-home-course">
                            ...
                            <div class="row my-2">
                                ...
                                <div class="form-floating col-sm-8 text-uppercase py-1">
                                    <input type="text" class="form-control form-control-sm" name="department" value="<?php echo e($course->mainCourses->getCourseDept->name); ?>" readonly>
                            ...
                            <div class="row my-2">
                                ...
                                <div class="form-floating col-sm-8 text-uppercase py-1">
                                    <input type="text" class="form-control form-control-sm" name="" value="<?php echo e($course->mainCourses->getCourseDept->schools->name); ?>" readonly>
                                    ...
                                    <div class="space-x-1">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="campus" value="Main"
                                                   ...
                                                   <?php if(old('campus') === 'Main'): ?> checked <?php endif; ?> required <?php if($mycourse != null && $mycourse->declaration === 1): ?> disabled <?php endif; ?>>
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="campus" value="Kwale"
                                                   ...
                                                   <?php if(old('campus') === 'Kwale'): ?>  checked <?php endif; ?> required <?php if($mycourse != null && $mycourse->declaration === 1): ?> disabled <?php endif; ?>>
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="campus" value="Lamu"
                                                   ...
                                                   <?php if(old('campus') === 'Lamu'): ?> checked <?php endif; ?> required <?php if($mycourse != null && $mycourse->declaration === 1): ?> disabled <?php endif; ?>>
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-sm-8 text-uppercase py-1">
                                    <div class="form-floating input-group">
                                        <span class="input-group-text input-group-text-sm col-md-3"><?php echo e(Str::limit( $course->mainCourses->courseRequirements->subject1, $limit = 10 , $end='' )); ?></span>
                            ...
                            <div class="row my-2">
                                ...
                                <div class="col-sm-8 text-uppercase py-1">
                                    <div class="form-floating input-group">
                                        <span class="input-group-text input-group-text-sm col-md-3"><?php echo e(Str::limit( $course->mainCourses->courseRequirements->subject2, $limit = 10 , $end='' )); ?></span>
                            ...
                            <div class="row my-2">
                                ...
                                <div class="form-floating col-sm-8 text-uppercase py-1">
                                    <div class="form-floating input-group">
                                        <span class="input-group-text input-group-text-sm col-md-3"><?php echo e(Str::limit( $course->mainCourses->courseRequirements->subject3, $limit = 10 , $end='' )); ?></span>
                            ...
                            <div class="row my-2">
                                ...
                                <div class="col-sm-8 text-uppercase py-1">
                                    <div class="form-floating input-group">
                                        <span class="input-group-text input-group-text-sm col-md-3"><?php echo e(Str::limit( $course->mainCourses->courseRequirements->subject4, $limit = 10 , $end='' )); ?></span>
...
<?php echo $__env->make('application::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Registrar/application/Modules/Application/Resources/views/applicant/application.blade.php ENDPATH**/ ?>