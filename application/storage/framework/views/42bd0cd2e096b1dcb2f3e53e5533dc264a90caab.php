          ...
          <ul class="nav-main">
              ...
              <a class="nav-main-link<?php echo e(request()->is('dashboard') ? ' active' : ''); ?>" href="<?php echo e(route('dashboard')); ?>">
                ...
                <span class="nav-main-link-name">
                    <?php $user = auth()->guard('user')->user(); ?>
                     <?php if($user->hasRole('STUDENT FINANCE')): ?>
                        Finance [ <?php echo e($user->employmentDepartment->first()->dept_code); ?> ]
                    <?php endif; ?>
                </span>
            ...
            <li class="nav-main-item<?php echo e(request()->is('intakes/*') ? ' open' : ''); ?>">
              ...
              <li class="nav-main-item<?php echo e(request()->is('intakes/*') ? ' open' : ''); ?>">
                  ...
                  <ul class="nav-main-submenu">
                      <li class="nav-main-item">
                          <a class="nav-main-link<?php echo e(request()->is('intake/showIntake') ? ' active' : ''); ?>" href="<?php echo e(route('finance.admissions')); ?>">
              ...
              <li class="nav-main-item<?php echo e(request()->is('intakes/*') ? ' open' : ''); ?>">
                  ...
                  <ul class="nav-main-submenu">
                      <li class="nav-main-item">
                          <a class="nav-main-link<?php echo e(request()->is('intake/showIntake') ? ' active' : ''); ?>" href="<?php echo e(route('finance.invoices')); ?>">
            ...
            <button type="button" class="btn btn-sm btn-alt-dark d-flex align-items-center" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              ...
              <span class="d-none d-sm-inline-block ms-2">
                  <?php if(auth()->guard('user')->check()): ?>
                      <?php echo e($user->staffInfos->title); ?> <?php echo e($user->staffInfos->last_name); ?>
            ...
            <div class="dropdown-menu dropdown-menu-md dropdown-menu-end p-0 border-0" aria-labelledby="page-header-user-dropdown">
              <div class="p-3 text-center bg-body-dark border-bottom rounded-top">
                ...
                <p class="mt-2 mb-0 fw-medium">
                  ...
                  <?php if(auth()->guard('user')->check()): ?>
                      <?php echo e($user->staffInfos->title); ?> <?php echo e($user->staffInfos->last_name); ?> <?php echo e($user->staffInfos->first_name); ?> <?php echo e($user->staffInfos->middle_name); ?>

                  <?php endif; ?>
                  <hr>
                  <p class="mb-0 text-muted fs-sm fw-medium">
                      <?php if(auth()->guard('user')->user()->hasRole('STUDENT FINANCE')): ?>
                          Finance [ <?php echo e($user->employmentDepartment->first()->dept_code); ?> ]
                      <?php endif; ?>
                </p>
              </div>
...
<?php /**PATH C:\xampp\htdocs\smis\application\Modules/Finance\Resources/views/layouts/backend.blade.php ENDPATH**/ ?>