            ...
            <div class="block-content block-content-full">
                <div class="row">
                    <div class="col-lg-6 mb-1">
                        ...
                        <?php if($app->cod_status === 2): ?>

                        <div class="row p-1">
                            <div class="col-md-4 fw-bolder text-start">Why rejected?</div>
                            <div class="col-md-8">
                                <p><?php echo e($app->cod_comments); ?></p>
                            </div>
                        </div>

                    <?php endif; ?>

                        <?php if($app->dean_status === 2): ?>

                            <div class="row p-1">
                                <div class="col-md-4 fw-bolder text-start">Why rejected?</div>
                                <div class="col-md-8">
                                    <p><?php echo e($app->dean_comments); ?></p>
                                </div>
                            </div>
...
<?php echo $__env->make('registrar::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Finale/application/Modules/Registrar/Resources/views/offer/preview.blade.php ENDPATH**/ ?>