                        ...
                        <?php if(count($courses)>0): ?>
                            ...
                            <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td nowrap="">
                                        <?php if($course->registrar_status === 1 && $course->cod_status === 1): ?>
...
<?php echo $__env->make('application::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xamp\htdocs\courses\project\application\Modules/Application\Resources/views/applicant/mycourses.blade.php ENDPATH**/ ?>