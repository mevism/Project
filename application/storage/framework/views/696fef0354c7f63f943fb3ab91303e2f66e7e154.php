    ...
    <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-6 mb-1">
                        ...
                        <div class="row p-1">
                            ...
                            <div class="col-md-8">
                                <p> <?php echo e($app->subject_1); ?></p>
                                <p> <?php echo e($app->subject_2); ?></p>
                                <p> <?php echo e($app->subject_3); ?></p>
                                <p> <?php echo e($app->subject_4); ?></p>
                            </div>
                        </div>
                        <div class="row p-1">
        ...
        <div class="d-flex justify-content-center py-1">
            ...
            <?php if($app->registrar_status === 0): ?>
                <a class="btn btn-sm btn-alt-success m-2" data-toggle="click-ripple" href="<?php echo e(route('courses.acceptApplication', $app->id)); ?>">Agree</a>
...
<?php echo $__env->make('registrar::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Registrar/application/Modules/Registrar/Resources/views/offer/viewApplication.blade.php ENDPATH**/ ?>