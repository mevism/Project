        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; width: 100%; max-width: 600px;  " class="content">
            ...
            <tr>
                <td align="center" class="bgcolor1" style="padding: 20px 20px 20px 20px; color: #ffffff; font-family: Arial, sans-serif; font-size: 36px; font-weight: bold;">
                    <img src="<?php echo e(asset('media/tum-logo/tum-logo.png')); ?>" alt="Tum Logo" width="160" height="152" style="display:block;" />
                </td>
            </tr>
            <tr>
                <td align="auto" class="bgcolor2" style="padding: 40px 20px 40px 20px; color: #555555; font-family: Arial, sans-serif; font-size: 20px; line-height: 30px; border-bottom: 1px solid #f6f6f6;">
                    ...
                    <p>
                        Congratulations for being approved as successfull applicant of Technical Univerisity of Mombasa. Please visit the <a href="<?php echo e(route('root')); ?>"> TUM Course Application Portal </a>to download your admission documents. For any queries reach use via our email tumsupport@tum.ac.ke
...
</html><?php /**PATH /var/www/html/Registrar/application/Modules/Registrar/Resources/views/mail/kuccpsemail.blade.php ENDPATH**/ ?>