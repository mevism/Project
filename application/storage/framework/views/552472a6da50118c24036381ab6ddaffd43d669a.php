    ...
    <div class="content">
        ...
        <div class="d-flex justify-content-center py-1">
            ...
            <?php if($app->dean_status == 3): ?>
                <a class="btn btn-sm btn-alt-success m-2" data-toggle="click-ripple" href="<?php echo e(route('dean.acceptApplication', [ 'id' => Crypt::encrypt($app->id)])); ?>">Agree</a>
            ...
            <div class="modal-content">
                <div class="block block-rounded block-transparent mb-0">
                    ...
                    <div class="block-content fs-sm">
                        <form action="<?php echo e(route('dean.rejectApplication', [ 'id' => Crypt::encrypt($app->id)])); ?>" method="post">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('dean::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\smis\application\Modules/Dean\Resources/views/applications/viewApplication.blade.php ENDPATH**/ ?>