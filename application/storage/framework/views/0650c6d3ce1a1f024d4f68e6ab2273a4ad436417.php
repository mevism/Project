          ...
          <ul class="nav-main">
            <li class="nav-main-item">
              <a class="nav-main-link<?php echo e(request()->is('dashboard') ? ' active' : ''); ?>" href="<?php echo e(route('dashboard')); ?>">
                ...
                <span class="nav-main-link-name">
                    ...
                    ?>
                    <?php if(auth()->guard('user')->user()->hasRole('CHAIRPERSON OF DEPARTMENT')): ?>
                        COD [ <?php echo e(auth()->guard('user')->user()->employmentDepartment->first()->dept_code); ?> ]
                    <?php endif; ?>
              ...
              <li class="nav-main-item<?php echo e(request()->is('intakes/*') ? ' open' : ''); ?>">
                  <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="true" href="#">
                      ...
                      <span class="nav-main-link-name">Academic Setup</span>
                  </a>
                  <ul class="nav-main-submenu">
                     <li class="nav-main-item">
                      ...
                      <li class="nav-main-item">
                          <a class="nav-main-link<?php echo e(request()->is('courses/showCourse') ? ' active' : ''); ?>" href="<?php echo e(route('department.allUnits')); ?>">
                              <span class="nav-main-link-name">Units</span>
                          </a>
                      </li>

                      <li class="nav-main-item">
                          <a class="nav-main-link<?php echo e(request()->is('courses/showCourse') ? ' active' : ''); ?>" href="<?php echo e(route('department.syllabi')); ?>">
            ...
            <li class="nav-main-item<?php echo e(request()->is('intakes/*') ? ' open' : ''); ?>">
              <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="true" href="<?php echo e(route('cod.applications')); ?>">
                <i class="nav-main-link-icon fas fa-list-1-2"></i>
              ...
              <li class="nav-main-item<?php echo e(request()->is('intakes/*') ? ' open' : ''); ?>">
                  ...
                  <ul class="nav-main-submenu">
                      <li class="nav-main-item">
                          <a class="nav-main-link<?php echo e(request()->is('intake/showIntake') ? ' active' : ''); ?>" href="<?php echo e(route('department.academicLeave')); ?>">
                  ...
                  <ul class="nav-main-submenu">
                      <li class="nav-main-item">
                          <a class="nav-main-link<?php echo e(request()->is('intake/showIntake') ? ' active' : ''); ?>" href="<?php echo e(route('department.readmissions')); ?>">
                  ...
                  <ul class="nav-main-submenu">
                      <li class="nav-main-item">
                          <a class="nav-main-link<?php echo e(request()->is('intake/showIntake') ? ' active' : ''); ?>" href="<?php echo e(route('department.supSpecials')); ?>">
                              <span class="nav-main-link-name">Sups/Specials</span>
                          </a>
                      </li>
                  </ul>
                  <ul class="nav-main-submenu">
              ...
              <li class="nav-main-item<?php echo e(request()->is('intakes/*') ? ' open' : ''); ?>">
                  ...
                  <ul class="nav-main-submenu">
                      <li class="nav-main-item">
                          <a class="nav-main-link<?php echo e(request()->is('intake/showIntake') ? ' active' : ''); ?>" href="<?php echo e(route('department.courseTransferSetup')); ?>">
                  ...
                  <ul class="nav-main-submenu">
                      <li class="nav-main-item">
                          <a class="nav-main-link<?php echo e(request()->is('intake/showIntake') ? ' active' : ''); ?>" href="<?php echo e(route('department.courseTransfers')); ?>">
                              <span class="nav-main-link-name">Course Transfers</span>
                          </a>
                      </li>
                  </ul>
              ...
              <li class="nav-main-item<?php echo e(request()->is('intakes/*') ? ' open' : ''); ?>">
                  ...
                  <ul class="nav-main-submenu">
                      <li class="nav-main-item">
                          <a class="nav-main-link<?php echo e(request()->is('intake/showIntake') ? ' active' : ''); ?>" href="<?php echo e(route('department.workload')); ?>">

                              <span class="nav-main-link-name">Prepare Workloads</span>
                          </a>
                      </li>
                  </ul>
                  ...
                  <ul class="nav-main-submenu">
                      <li class="nav-main-item">
                          <a class="nav-main-link<?php echo e(request()->is('intake/showIntake') ? ' active' : ''); ?>" href="<?php echo e(route('department.viewWorkload')); ?>">
              ...
              <li class="nav-main-item<?php echo e(request()->is('intakes/*') ? ' open' : ''); ?>">
                ...
                <ul class="nav-main-submenu">
                    <li class="nav-main-item">
                        <a class="nav-main-link<?php echo e(request()->is('intake/showIntake') ? ' active' : ''); ?>" href="<?php echo e(route('department.yearlyResults')); ?>">
                            <span class="nav-main-link-name">View Ordinary Exams</span>
                        </a>
                    </li>
                </ul>
                  <ul class="nav-main-submenu">
                      <li class="nav-main-item">
                          <a class="nav-main-link<?php echo e(request()->is('intake/showIntake') ? ' active' : ''); ?>" href="#">
                              <span class="nav-main-link-name">View Special/Sup Exams</span>
                          </a>
                      </li>
                  </ul>
                  <ul class="nav-main-submenu">
                      <li class="nav-main-item">
                          <a class="nav-main-link<?php echo e(request()->is('intake/showIntake') ? ' active' : ''); ?>" href="#">
                              <span class="nav-main-link-name">View Retakes Exams</span>
                          </a>
                      </li>
                  </ul>
            </li>
              ...
              <li class="nav-main-item<?php echo e(request()->is('intakes/*') ? ' open' : ''); ?>">
                  <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="true" href="<?php echo e(route('cod.applications')); ?>">
                      ...
                      <span class="nav-main-link-name">Lecturers</span>
                  </a>
                  <ul class="nav-main-submenu">
                      <li class="nav-main-item">
                          <a class="nav-main-link<?php echo e(request()->is('intake/showIntake') ? ' active' : ''); ?>" href="<?php echo e(route('department.lecturers')); ?>">

                              <span class="nav-main-link-name">Department Lecturers</span>
                          </a>
                      </li>
                  </ul>
                  ...
                  <ul class="nav-main-submenu">
                      <li class="nav-main-item">
                          <a class="nav-main-link<?php echo e(request()->is('intake/showIntake') ? ' active' : ''); ?>" href="<?php echo e(route('department.lecturesQualification')); ?>">

                              <span class="nav-main-link-name">Lecturer Qualification & Teaching Areas</span>
                          </a>
                      </li>
                  </ul>
              </li>
              <li class="nav-main-item">
                  ...
                  <div class="tum-logo">
                      <img class="mb-2" src="<?php echo e(asset('media/tum-logo/tum-logo.png')); ?>" alt="TUM Logo" style="height: 90px; width: 120px;"> <br>
                      <img src="<?php echo e(asset('media/tum-logo/iso.png')); ?>" alt="TUM Logo" style="height: 40px; width: 150px;">
                  </div>
              </li>
          </ul>
        </div>
