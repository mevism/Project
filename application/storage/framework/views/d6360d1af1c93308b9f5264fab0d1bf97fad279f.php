        ...
        <div class="content-side">
          <ul class="nav-main">
            ...
            <li class="nav-main-item<?php echo e(request()->is('pages/*') ? ' open' : ''); ?>">
              ...
              <?php if($user->enrolledCourse->student_type == 2): ?>
                    <ul class="nav-main-submenu">
                        <li class="nav-main-item">
              ...
              <li class="nav-main-item<?php echo e(request()->is('pages/*') ? ' open' : ''); ?>">
                  ...
                  <ul class="nav-main-submenu">
                      <li class="nav-main-item">
                          <a class="nav-main-link<?php echo e(request()->is('pages/datatables') ? ' active' : ''); ?>" href="#">
...
<?php /**PATH C:\xampp\htdocs\smis\application\Modules/Student\Resources/views/layouts/backend.blade.php ENDPATH**/ ?>