        ...
        <div class="content-side">
          <ul class="nav-main">
            <li class="nav-main-item">
              <a class="nav-main-link<?php echo e(request()->is('dashboard') ? ' active' : ''); ?>" href="<?php echo e(route('dashboard')); ?>">
                ...
                <span class="nav-main-link-name">
                    <?php if(auth()->guard('user')->user()->hasRole('Director/Dean')): ?>
                        Director/Dean
                    <?php endif; ?>
                </span>
            ...
            <li class="nav-main-item<?php echo e(request()->is('intakes/*') ? ' open' : ''); ?>">
              ...
              <ul class="nav-main-submenu">
                <li class="nav-main-item">
                    <a class="nav-main-link<?php echo e(request()->is('intake/showIntake') ? ' active' : ''); ?>" href="<?php echo e(route('dean.yearly')); ?>">
                        <i class="nav-main-link-icon si si-calendar"></i>
              ...
              <ul class="nav-main-submenu">
                  <li class="nav-main-item">
                      <a class="nav-main-link<?php echo e(request()->is('intake/showIntake') ? ' active' : ''); ?>" href="<?php echo e(route('dean.academicLeave')); ?>">
                          <i class="nav-main-link-icon si si-calendar"></i>
              ...
              <ul class="nav-main-submenu">
                <li class="nav-main-item">
                    <a class="nav-main-link<?php echo e(request()->is('intake/showIntake') ? ' active' : ''); ?>" href="<?php echo e(route('dean.readmissions')); ?>">
                        <i class="nav-main-link-icon si si-calendar"></i>
            ...
            <li class="nav-main-item<?php echo e(request()->is('intakes/*') ? ' open' : ''); ?>">
              ...
              <ul class="nav-main-submenu">
                  <li class="nav-main-item">
                      <a class="nav-main-link<?php echo e(request()->is('intake/showIntake') ? ' active' : ''); ?>" href="<?php echo e(route('dean.workload')); ?>">
                          <i class="nav-main-link-icon si si-calendar"></i>
            ...
            <button type="button" class="btn btn-sm btn-alt-dark d-flex align-items-center" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              ...
              <span class="d-none d-sm-inline-block ms-2">
                  <?php if(Auth::guard('user')->check()): ?>
                      <?php echo e(Auth::guard('user')->user()->title); ?> <?php echo e(Auth::guard('user')->user()->last_name); ?>
            ...
            <div class="dropdown-menu dropdown-menu-md dropdown-menu-end p-0 border-0" aria-labelledby="page-header-user-dropdown">
              <div class="p-3 text-center bg-body-dark border-bottom rounded-top">
                ...
                <p class="mt-2 mb-0 fw-medium">
                    ...
                    <?php if(Auth::guard('user')->check()): ?>
                        <?php echo e(Auth::guard('user')->user()->title); ?> <?php echo e(Auth::guard('user')->user()->last_name); ?> <?php echo e(Auth::guard('user')->user()->first_name); ?> <?php echo e(Auth::guard('user')->user()->middle_name); ?>
...
<?php /**PATH /var/www/html/Work/Tum/Project/application/Modules/Dean/Resources/views/layouts/backend.blade.php ENDPATH**/ ?>