        ...
        <div class="block-content block-content-full">
            <div class="row">
                <div class="col-12">
                    <div class="d-flex justify-content-center m-2">
                        ...
                        <div class="col-md-6 p-2">
                            <fieldset class="border p-2" style="height: 100% !important;">
                                ...
                                <form method="POST" action="<?php echo e(route('department.acceptReadmission', ['id' => Crypt::encrypt($leave->id)])); ?>">
                                    <?php echo csrf_field(); ?>
                                    <div class="row mb-3">
                    ...
                    <div class="d-flex justify-content-center m-2">
                        <?php if($leave->readmissionApproval == null): ?>
                        ...
                        <?php else: ?>
                            <?php if($leave->readmissionApproval->cod_status == 1): ?>
                                <a class="btn btn-outline-danger col-md-2 m-2" data-bs-toggle="modal" data-bs-target="#staticBackdrop"> Decline Transfer </a>
                            <?php else: ?>
                                <button class="btn btn-outline-success col-md-2 m-2"> Accept Transfer </button>
                            <?php endif; ?>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="<?php echo e(route('department.declineReadmission', ['id' => Crypt::encrypt($leave->id)])); ?>">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('cod::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Courses/application/Modules/COD/Resources/views/readmissions/viewSelectedReadmission.blade.php ENDPATH**/ ?>