                ...
                <table id="example"  class="table table-sm table-striped table-bordered fs-sm">
                    ...
                    <?php $__currentLoopData = $course; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <?php if($course->student->status == 1 && \Carbon\Carbon::parse($course->courseEntry->year_start)->addYears( explode(' ', $course->studentCourse->courseRequirements->course_duration)[0] )->format('M Y') > \Carbon\Carbon::now()->format('M Y')): ?>
...
<?php echo $__env->make('student::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Registrar/application/Modules/Student/Resources/views/courses/index.blade.php ENDPATH**/ ?>