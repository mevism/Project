                        ...
                        <div class="col-12 mb-4">
                            ...
                            <div class="space-x-2">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="main" value="<?php echo e($camp->id); ?>" <?php if(old('main') === 'campus'): ?> checked <?php endif; ?> >
                                    <label class="form-check-label"><?php echo e($camp->name); ?></label>
                                </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
...
<?php echo $__env->make('registrar::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Registrar/application/Modules/Registrar/Resources/views/course/addCourse.blade.php ENDPATH**/ ?>