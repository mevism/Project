        ...
        <div class="bg-image" style="background-image: {{ url('media/photos/photo10@2x.jpg') }};">
            <div class="bg-primary-dark-op">
                <div class="content content-full text-center">
                        ...
                        @if($user->loggedStudent->ID_photo == NULL)
                            @if($user->loggedStudent->gender == 'M')
                            <div class="my-3">
                                <img class="img-avatar img-avatar-thumb" src="{{ url('media/avatars/male.jpg') }}" alt="">
                            </div>
                            @else
                            <div class="my-3">
                                <img class="img-avatar img-avatar-thumb" src="{{ url('media/avatars/female.jpg') }}" alt="">
                            </div>
                            @endif
                        @else
                            <div class="my-3">
                    ...
                    <h2 class="h4 fw-normal text-white-75 mt-4">
                        {{ $user->loggedStudent->title }} {{ $user->loggedStudent->sname }} {{ $user->loggedStudent->fname }} {{ $user->loggedStudent->mname }}
                    </h2>
                </div>
            </div>
        </div>
