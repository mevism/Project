                ...
                <div class="col-lg-12">
                    <table id="example" class="table table-responsive table-md table-striped table-bordered table-vcenter fs-sm">
                        ...
                        @foreach($admission as $app)
                            <tr>
                                <td nowrap="">{{ $app->admitKuccps->kuccpsApplicant->sname }} {{ $app->admitKuccps->kuccpsApplicant->fname }} {{ $app->admitKuccps->kuccpsApplicant->mname }}</td>
                                ...
                                <td nowrap="">
                                    ...
                                    @if($app->medical_status === 0)
                                        <a class="btn btn-sm btn-alt-success" data-toogle="click-ripple" onclick="return confirm('Are you sure you want to approve?')" href="{{ route('medical.acceptAdmJab', $app->id) }}"> approve</a>
                                    ...
                                    @elseif($app->medical_status === 1)
                                        <a class="btn btn-sm btn-alt-success" data-toogle="click-ripple" href="{{ route('medical.submitAdmJab',$app->id) }}"> submit</a>
