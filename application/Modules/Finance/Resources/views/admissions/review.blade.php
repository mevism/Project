    ...
    <div class="content">
            ...
            <div class="block-content block-content-full">
                <div class="row">
                    <div class="col-lg-6 mb-0 fs-sm">
                        ...
                        <div class="col-md-8"> {{ $app->appApproval->applicant->sname }} {{ $app->appApproval->applicant->fname }} {{ $app->appApproval->applicant->mname }}</div>
                        </div>
                        <div class="row p-1">
                            <div class="col-md-4 fw-bolder text-start">Course Name</div>
                            <div class="col-md-8"> {{ $app->appApproval->courses->course_name }} </div>
                        </div>
                        <div class="row p-1">
                            <div class="col-md-4 fw-bolder text-start">Transaction Code</div>
                            <div class="col-md-8"> {{ $app->appApproval->receipt }} </div>
                        </div>
                    </div>
                    <div class="col-lg-6 space-y-1">
                        <div class="d-flex justify-content-center">
                            <div class="card-img" style="margin: auto !important;">
                                <img style="margin: auto !important; max-height: 80vh !important; width: 100% !important;" src="{{ url('receipts/', $app->appApproval->receipt_file) }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="d-flex justify-content-center py-1">
            @if($app->finance_status === 0)
                <a class="btn btn-sm btn-alt-success m-2" data-toggle="click-ripple" href="{{ route('finance.acceptAdmission', $app->id) }}">Approve</a>
