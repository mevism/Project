                ...
                <div class="col-lg-12">
                    <table id="example" class="table table-responsive table-md table-striped table-bordered table-vcenter fs-sm">
                        ...
                        @foreach($applicant as $app)
                            <tr>
                                <td> {{ $app->admitKuccps->kuccpsApplicant->sname }} {{ $app->admitKuccps->kuccpsApplicant->fname }} {{ $app->admitKuccps->kuccpsApplicant->mname }}</td>
                                <td>{{ $app->admitKuccps->course_code }}</td>
                                <td>{{ $app->admitKuccps->course_name }}</td>
{{--                                <td>{{ $app->appApprovals->receipt }}</td>--}}
                                ...
                                <td>
                                    @if($app->finance_status === 0)
                                        <a class="btn btn-sm btn-alt-success" data-toogle="click-ripple" onclick="return confirm('Are you sure you want to approve this record?')" href="{{ route('finance.acceptAdmJab', $app->id) }}"> Accept</a>
                                    ...
                                    @elseif($app->finance_status === 1)
                                        <a class="btn btn-sm btn-success" data-toogle="click-ripple" href="{{ route('finance.submitAdmJab',$app->id) }}"> submit</a>
                                        <a class="btn btn-sm btn-alt-danger m-2" href="#" data-bs-toggle="modal" data-bs-target="#modal-block-popin"> Reject</a>
                                        <div class="modal fade" id="modal-block-popin" tabindex="-1" role="dialog" aria-labelledby="modal-block-popin" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-popin" role="document">
                                                <div class="modal-content">
