    ...
    public function requestedTransfers($id){
       ...
       $courses = Courses::all();
        ...
        foreach ($transfers as $course => $transfer) {
            ...
            $table->addCell(1700, ['borderSize' => 1])->addText('Student Points/Grade', $center, ['name' => 'Book Antiqua', 'size' => 11, 'bold' => true, 'align' => 'center']);
            ...
            foreach ($transfer as $key => $list) {
                ...
                $table->addCell(1700, ['borderSize' => 1])->addText(strtoupper($list->student_points), ['name' => 'Book Antiqua', 'size' => 10, 'align' => 'center']);
