    ...
    public function requestedTransfers($id){
       ...
       $courses = Courses::all();
        ...
        foreach ($transfers as $course => $transfer) {
            ...
            $table->addCell(3000, ['borderSize' => 1])->addText('Student Name/ Reg. Number', $center, ['align' => 'center', 'name' => 'Book Antiqua', 'size' => 11, 'bold' => true]);
            $table->addCell(1500, ['borderSize' => 1])->addText('Course Admitted', $center, ['name' => 'Book Antiqua', 'size' => 11, 'bold' => true, 'align' => 'center']);
            $table->addCell(1600, ['borderSize' => 1])->addText('Course Transferring to', $center, ['name' => 'Book Antiqua', 'size' => 11, 'bold' => true, 'align' => 'center']);
            ...
            $table->addCell(3000, ['borderSize' => 1])->addText('COD Remarks', $center, ['name' => 'Book Antiqua', 'size' => 11, 'bold' => true, 'align' => 'center']);
            ...
            foreach ($transfer as $key => $list) {
                ...
                $table->addCell(3000, ['borderSize' => 1])->addText($name, ['name' => 'Book Antiqua', 'size' => 10]);
                ...
                $table->addCell(3000, ['borderSize' => 1])->addText($remarks, ['name' => 'Book Antiqua', 'size' => 10, 'align' => 'center']);
