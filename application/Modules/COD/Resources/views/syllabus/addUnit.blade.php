        ...
        <div class="block-content block-content-full">
            <div class="row">
                <div class="table-responsive col-12">
                    <form method="POST" action="{{ route('department.storeUnit') }}">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <fieldset class="border p-2" style="height: 100% !important;">
                                    ...
                                    <div class="mb-2 form-floating">
                                        <input type="text" class="form-control" name="unit_code" value="{{ old('unit_code') }}" placeholder="unit code">
                                        <label>UNIT CODE <sup class="text-danger">*</sup> </label>
                                    </div>
                                    <div class="mb-2 form-floating">
                                        <input type="text" class="form-control" name="unit_name" value="{{ old('unit_name') }}" placeholder="unit code">
                                        <label>UNIT NAME <sup class="text-danger">*</sup> </label>
                                    </div>
                                    <div class="mb-2 form-floating">
                                        <select class="form-control" name="unit_type" >
                                            <option selected disabled class="text-center"> -- select -- </option>
                                            <option value="1">University Unit</option>
                                    ...
                                    <div class="mb-2 form-floating">
                                        <input type="text" class="form-control" name="total_cat" value="{{ old('total_cat') }}" placeholder="unit code">
                            ...
                            <div class="col-md-6">
                                <fieldset class="border p-2" style="height: 100% !important;">
                                    ...
                                    <div class="mb-2 form-floating">
                                        <input type="text" class="form-control" name="cat" value="{{ old('cat') }}" placeholder="unit code">
                                        <label>CAT <sup class="text-danger">*</sup> </label>
                                    </div>
                                    <div class="mb-2 form-floating">
                                        <input type="text" class="form-control" name="assignment" value="{{ old('assignment') }}" placeholder="unit code">
                                        <label>ASSIGNMENT(s) </label>
                                    </div>
                                    <div class="mb-2 form-floating">
                                        <input type="text" class="form-control" name="practical" value="{{ old('practical') }}" placeholder="unit code">
                            ...
                            <div class="mt-4 d-flex justify-content-center">
                                <button class="btn btn-md btn-outline-success col-md-7">Submit Unit</button>
                            </div>
                        </div>
                    </form>
