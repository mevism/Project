            ...
            <div class="row">
                <div class="col-12">
                    <div class="d-flex justify-content-center m-2">
                        ...
                        <div class="col-md-6 p-2">
                            <fieldset class="border p-2" style="height: 100% !important;">
                                ...
                                <form method="POST" action="{{ route('department.acceptReadmission', ['id' => Crypt::encrypt($leave->id)]) }}">
                                    @csrf
                                    <div class="row mb-3">
                    ...
                    <div class="d-flex justify-content-center m-2">
                        ...
                        @else
                            @if($leave->readmissionApproval->cod_status == 1)
                                <a class="btn btn-outline-danger col-md-2 m-2" data-bs-toggle="modal" data-bs-target="#staticBackdrop"> Decline Transfer </a>
                            @else
                                <button class="btn btn-outline-success col-md-2 m-2"> Accept Transfer </button>
                            @endif
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('department.declineReadmission', ['id' => Crypt::encrypt($leave->id)]) }}">
                        @csrf
