    ...
    <div class="content">
        <div class="block block-rounded">
                ...
                <div class="row">
                    <div class="col-lg-5 mb-1 fs-sm">
                        ...
                        <div class="row p-1">
                            ...
                            <div class="col-md-8"> {{ $app->admissionCourse->getCourseDept->name }} </div>
                        </div>
                        <div class="row p-1">
                            <div class="col-md-4 fw-bolder text-start">Course Name</div>
                            <div class="col-md-8"> {{ $app->admissionCourse->course_name }} </div>
                        </div>
                        <div class="row p-1">
            ...
            <div class="d-flex justify-content-center py-1">
                ...
                @if($app->cod_status == 0)
                    <a class="btn btn-sm btn-alt-success m-2" data-toggle="click-ripple" href="{{ route('cod.acceptAdmission',$app->application_id) }}"> Accept </a>
            ...
            <div class="modal-content">
                <div class="block block-rounded block-transparent mb-0">
                    ...
                    <div class="block-content fs-sm">
                        <form action="{{ route('cod.rejectAdmission', $app->application_id) }}" method="post">
                            @csrf
    ...
    <div class="modal fade" id="modal-block-popin1" tabindex="-1" role="dialog" aria-labelledby="modal-block-popin" aria-hidden="true">
        <div class="modal-dialog modal-dialog-popin" role="document">
            <div class="modal-content">
                <div class="block block-rounded block-transparent mb-0">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">Reason(s) for withholding {{ $app->sname }}'s admission</h3>
                        <div class="block-options">
                            <button type="button" class="btn-block-option" data-bs-dismiss="modal" aria-label="Close">
                                <i class="fa fa-fw fa-times"></i>
                            </button>
                    ...
                    <div class="block-content fs-sm">
                        <form action="{{ route('cod.withholdAdmission', $app->application_id) }}" method="post">
                            @csrf
                            <div class="row col-md-12 mb-3">
                                <div class="d-flex justify-content-center">
