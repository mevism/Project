...
return new class extends Migration
{
    ...
    public function up()
    {
        DB::statement(
            ...
            SELECT application_approvals.finance_status, application_approvals.transaction_number, application_approvals.cod_status, application_approvals.cod_comments,application_approvals.cod_user_id, application_approvals.dean_status, application_approvals.dean_comments,application_approvals.dean_user_id, application_approvals.registrar_status, application_approvals.registrar_comments,application_approvals.registrar_user_id,application_approvals.admission_letter,accepted_students.reference_number, accepted_students.student_number, applications.applicant_id, applications.intake_id, applications.student_type, applications.campus_id,   applications.course_id, applications.declaration, applications.status, application_subjects.subject_1, application_subjects.subject_2, application_subjects.subject_3, application_subjects.subject_4, applicant_infos.title, applicant_infos.first_name, applicant_infos.middle_name, applicant_infos.surname, applicant_infos.gender, applicant_addresses.town, applicant_addresses.address, applicant_addresses.postal_code, applicant_contacts.mobile, applicant_contacts.email, applications.created_at
