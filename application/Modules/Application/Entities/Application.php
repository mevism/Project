...
class Application extends Model
{
    ...
    protected $fillable = ['application_id', 'applicant_id', 'ref_number', 'intake_id', 'student_type', 'campus_id', 'course_id', 'declaration', 'status', 'application_number', 'application_fee', ];
