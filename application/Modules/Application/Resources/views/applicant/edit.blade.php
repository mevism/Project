    ...
    <div class="content content-boxed">
        <div class="row">
            <div class="col-md-12 col-xl-12">
                <!-- Updates -->
                <form class="js-validation-signin" method="post" action="{{ route('application.update', $app->id) }}" enctype="multipart/form-data">
                    @csrf
                                ...
                                <div class="block-content">
                                    <div class="row" style="padding: 5px !important;">
                                        ...
                                        <div class="col-sm-8 text-uppercase" style="padding: 5px !important;">
                                            <input type="text" class="form-control form-control-alt" name="school" value="{{ $app->courses->school_id }}" readonly>
                                            <input type="hidden" name="intake" value="{{ $app->intake_id }}">
                                    ...
                                    <div class="row" style="padding: 5px !important;">
                                        ...
                                        <div class="col-sm-8 text-uppercase" style="padding: 5px !important;">
                                            <input type="text" class="form-control form-control-alt" name="department" value="{{ $app->courses->department_id }}" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row" style="padding: 5px !important;">
                                        ...
                                        <div class="col-sm-8 text-uppercase" style="padding: 5px !important;">
                                            <input type="text" class="form-control form-control-alt" name="course" value="{{ $app->courses->course_name }}" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="timeline-event-block block">
                                ...
                                <div class="block-content">
                                    <div class="row" style="padding: 5px !important;">
                                        ...
                                        <div class="col-sm-8 text-uppercase" style="padding: 5px !important;">
                                            <div class="input-group">
                                                <span class="input-group-text input-group-text-alt">{{ Str::limit( $app->courses->subject1, $limit = 3 , $end='' )  }}</span>
                                                <input type="text" class="form-control form-control-alt" name="subject1" value="{{ $app->subject_1 }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row" style="padding: 5px !important;">
                                        ...
                                        <div class="col-sm-8 text-uppercase" style="padding: 5px !important;">
                                            <div class="input-group">
                                                <span class="input-group-text input-group-text-alt">{{ Str::limit( $app->courses->subject2, $limit = 3 , $end='' )  }}</span>
                                                <input type="text" class="form-control form-control-alt" name="subject2" value="{{ $app->subject_2 }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row" style="padding: 5px !important;">
                                        ...
                                        <div class="col-sm-8 text-uppercase" style="padding: 5px !important;">
                                            <div class="input-group">
                                                <span class="input-group-text input-group-text-alt">{{ Str::limit( $app->courses->subject3, $limit = 8 , $end='' )  }}</span>
                                                <input type="text" class="form-control form-control-alt" name="subject3" value="{{ $app->subject_3 }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row" style="padding: 5px !important;">
                                        ...
                                        <div class="col-sm-8 text-uppercase" style="padding: 5px !important;">
                                            <div class="input-group">
                                                <span class="input-group-text input-group-text-alt">{{ Str::limit( $app->courses->subject4, $limit = 8 , $end='' )  }}</span>
                                                <input type="text" class="form-control form-control-alt" name="subject4" value="{{ $app->subject_1 }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="timeline-event-block block">
                                ...
                                <div class="block-content">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="py-2 mb-0">
                                                You are required to pay <span class="fw-bold">Ksh. {{ $app->courses->fee }} </span> to complete this application.
                                            ...
                                            <div class="text-uppercase" style="padding: 7px !important;">
                                                <input type="text" class="form-control form-control-alt" required value="{{ $app->receipt }}" name="receipt" placeholder="Enter RECEIPT NUMBER">
                                            </div>
                                            <div class="text-uppercase" style="padding: 7px !important;">
                                                <input type="file" class="form-control form-control-alt" required value="{{ $app->receipt_file }}" name="receipt_file">
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
{{--                                <div class="timeline-event-block block">--}}
{{--                                    <div class="block-header">--}}
{{--                                        <h3 class="block-title">Working Experience <span class="fs-sm text-danger text-lowercase fw-normal"><sup>*</sup> You are required to fill your education history again afresh </span> </h3>--}}
{{--                                        <div class="block-options">--}}
{{--                                            <div class="timeline-event-time block-options-item fs-sm">--}}
{{--                                                <i class="fa fa-info" title="user information"></i>--}}
{{--                                            </div>--}}
