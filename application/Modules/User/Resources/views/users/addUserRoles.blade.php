                ...
                <div class="col-md-6">
                    <fieldset class="border p-2 fs-sm" style="height: 100% !important;">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-9">: {{ $user->staff_number }}</div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-3 fw-semibold">Staff Name </div>
                            <div class="col-9">: {{ $user->title }} {{ $user->last_name }} {{ $user->first_name }} {{ $user->middle_name }}</div>
                        </div>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-9">: {{ $user->office_email }}</div>
                        </div>
