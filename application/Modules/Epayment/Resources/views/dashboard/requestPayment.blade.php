@extends('epayment::layouts.backend')
<style>
    .amount {
                ...
                <div class="col-lg-6">
                    <fieldset class="border p-2" style="height: 100% !important;">
                        ...
                        <div class="mb-4">
                            ...
                            <span class="h6 fs-sm fw-normal"> {{ auth()->guard('epayments')->user()->student_name }} </span>
                        </div>
                        <div class="mb-4">
                            <span class="h5 fs-sm">STUDENT NUMBER : </span>
                            <span class="h6 fs-sm fw-normal"> {{ auth()->guard('epayments')->user()->username }} </span>
                        </div>
                        <div class="mb-4">
                            <span class="h5 fs-sm">STUDENT NAME : </span>
                            <span class="h6 fs-sm fw-normal"> {{ auth()->guard('epayments')->user()->student_email }} </span>
                        </div>
                        <div class="mb-4">
                            <span class="h5 fs-sm">PHONE NUMBER : </span>
                            <span class="h6 fs-sm fw-normal"> {{ auth()->guard('epayments')->user()->phone_number }}</span>
                        </div>
                    </fieldset>
                </div>
