          ...
          <ul class="nav-main">
            <li class="nav-main-item">
              <a class="nav-main-link{{ request()->is('dashboard') ? ' active' : '' }}" href="{{ route('dashboard') }}">
                ...
                <span class="nav-main-link-name">
                    ...
                    @elseif(auth()->guard('user')->user()->id == 8)
                        MEDICAL
                    @elseif(auth()->guard('user')->user()->id == 5)
                        ACCOMMODATION
                    @else
              ...
              <li class="nav-main-item{{ request()->is('intakes/*') ? ' open' : '' }}">
                  <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="true" href="{{ route('hostel.allocations') }}">
                      <i class="nav-main-link-icon si si-graduation"></i>
                      <span class="nav-main-link-name">Allocations</span>
                  </a>
                  <ul class="nav-main-submenu">
                      <li class="nav-main-item">
                          <a class="nav-main-link{{ request()->is('intake/showIntake') ? ' active' : '' }}" href="{{ route('hostel.allocations') }}">
                              <i class="nav-main-link-icon si si-calendar"></i>
                              <span class="nav-main-link-name">Allocate</span>
                          </a>
                      </li>
                  </ul>
              </li>
