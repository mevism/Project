                    ...
                    <table id="example" class="table table-responsive table-md table-striped table-bordered table-vcenter fs-sm">
                        @if(count($admission)>0)
                            ...
                            @foreach($admission as $app)
                                <tr>
                                    <td nowrap=""> {{ $app->kuccpsStudent->kuccpsApplicant->sname }} {{ $app->kuccpsStudent->kuccpsApplicant->fname }} {{ $app->kuccpsStudent->kuccpsApplicant->mname }} </td>
                                    <td> {{ $app->kuccpsStudent->course_code }}</td>
                                    <td> {{ $app->kuccpsStudent->course_name }}</td>
                                    <td>
