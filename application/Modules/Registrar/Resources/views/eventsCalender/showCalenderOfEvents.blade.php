          ...
          <table id="example" class="table table-bordered table-striped table-vcenter fs-sm">
            ...
            <tbody>
              ...
              <tr>
                 ...
                 <td>
                    <a class="btn btn-sm btn-alt-info" href="{{ route('courses.editCalenderOfEvents', ['id'=> Crypt::encrypt($item->id)]) }}">edit</a>
                    <a class="btn btn-sm btn-alt-danger" onclick="return confirm('Are you sure you want to delete this record ?')" href="{{ route('courses.showCalenderOfEvents', $item->id) }}">delete</a>
                  </td>
             </tr>
              @endforeach
            </tbody>
