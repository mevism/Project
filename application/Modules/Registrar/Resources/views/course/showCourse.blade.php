...
COD SUBMIT REJECT
finance rejecting wrong

cc and bcc errors when sending emails

data subjects to be in a different table
create 

have customized id
cod names...  eg cod Computer science
...
add course units beside the actions in course(syllabus)
fee structure

when a student is admitted, the process should automatically register the student 1.1. depending on the course

change the intake in Classes

invoicing 
profoma invoice to go with the finance

addmision to end with automatic invoicing

student admited to certain courses with unregistered status , student register, status changes to registered

account number , amount paid

remove every sem invoice

accommodation - 

student be able to view units

clusters for every school
